...
class FilterConfig {
  ...
  static List<FilterFieldOption> _buildCommonSortVideoImage() {
    return [
      FilterFieldOption(
        value: 'date',
        label: slang.t.searchFilter.sortTypes.latest,
      ),
      FilterFieldOption(
        value: 'relevance',
        label: slang.t.searchFilter.sortTypes.relevance,
      ),
      FilterFieldOption(
        value: 'views',
        label: slang.t.searchFilter.sortTypes.views,
      ),
      FilterFieldOption(
        value: 'likes',
        label: slang.t.searchFilter.sortTypes.likes,
      ),
    ];
  }
  ...
  static const Map<FilterFieldType, List<FilterOperator>> _operators = {
    ...
    FilterFieldType.STRING_ARRAY: [FilterOperator.IN, FilterOperator.NOT_IN],
    FilterFieldType.SELECT: [FilterOperator.EQUALS, FilterOperator.NOT_EQUALS],
  };
    ...
    SearchSegment.user: FilterContentType(
      ...
      fields: [
        FilterField(
          ...
          displayName: slang.t.searchFilter.username,
        ...
        FilterField(
          ...
          type: FilterFieldType.STRING,
          isLocalizable: true,
          displayName: slang.t.searchFilter.nickname,
        ...
        FilterField(
          ...
          displayName: slang.t.searchFilter.registrationDate,
        ...
        FilterField(
          ...
          type: FilterFieldType.STRING,
          isLocalizable: true,
          displayName: slang.t.searchFilter.description,
    ...
    SearchSegment.video: FilterContentType(
      ...
      fields: [
        FilterField(
          ...
          type: FilterFieldType.STRING,
          isLocalizable: true,
          displayName: slang.t.searchFilter.title,
        ...
        FilterField(
          name: 'tags',
          type: FilterFieldType.STRING_ARRAY,
          displayName: slang.t.searchFilter.tags,
        ...
        FilterField(
          name: 'author',
          type: FilterFieldType.STRING,
          displayName: slang.t.searchFilter.author,
        ...
        FilterField(
          name: 'date',
          type: FilterFieldType.DATE,
          displayName: slang.t.searchFilter.publishDate,
          iconData: Icons.calendar_today,
          iconColor: Colors.brown,
        ),
        FilterField(
          ...
          displayName: slang.t.searchFilter.private,
          iconData: Icons.lock,
        ...
        FilterField(
          ...
          displayName: slang.t.searchFilter.duration,
        ...
        FilterField(
          name: 'likes',
          type: FilterFieldType.NUMBER,
          displayName: slang.t.searchFilter.likes,
        ...
        FilterField(
          name: 'views',
          type: FilterFieldType.NUMBER,
          displayName: slang.t.searchFilter.views,
        ...
        FilterField(
          name: 'comments',
          type: FilterFieldType.NUMBER,
          displayName: slang.t.searchFilter.comments,
        ...
        FilterField(
          ...
          options: [
            ...
            FilterFieldOption(
              value: 'ecchi',
              label: slang.t.searchFilter.adult,
            ),
            FilterFieldOption(
              value: 'general',
              label: slang.t.searchFilter.general,
            ),
          ],
        ),
      ],
    ...
    SearchSegment.image: FilterContentType(
      ...
      fields: [
        ...
        FilterField(
          name: 'images',
          type: FilterFieldType.NUMBER,
          displayName: slang.t.searchFilter.imageCount,
    ...
    SearchSegment.post: FilterContentType(
      ...
      fields: [
        ...
        FilterField(
          ...
          type: FilterFieldType.STRING,
          isLocalizable: true,
          displayName: slang.t.searchFilter.content,
          iconData: Icons.description,
          iconColor: Colors.indigo,
        ),
        FilterField(
    ...
    SearchSegment.playlist: FilterContentType(
      ...
      fields: [
        ...
        FilterField(
          name: 'videos',
          type: FilterFieldType.NUMBER,
          displayName: slang.t.searchFilter.videoCount,
        ...
        FilterField(
          name: 'date',
          type: FilterFieldType.DATE,
          displayName: slang.t.searchFilter.createDate,
          iconData: Icons.calendar_today,
          iconColor: Colors.brown,
        ),
      ],
  ...
  static String generateFilterString(Filter filter, FilterField field) {
    final fieldName = filter.locale != null
        ? '${filter.field}_${filter.locale}'
        : filter.field;
    ...
    switch (filter.operator) {
      ...
      case FilterOperator.RANGE:
        ...
        if (field.type == FilterFieldType.DATE) {
          // 处理日期范围
          try {
            if (filter.value['from'] != null &&
                filter.value['from'].toString().isNotEmpty) {
              from =
                  (DateTime.parse(
                            filter.value['from'].toString(),
          ...
          try {
            if (filter.value['to'] != null &&
                filter.value['to'].toString().isNotEmpty) {
              to =
                  (DateTime.parse(
                            filter.value['to'].toString(),
                          ).millisecondsSinceEpoch /
                          1000)
                      .floor();
            }
      ...
      default:
        ...
        if (field.type == FilterFieldType.DATE) {
          try {
            value =
                (DateTime.parse(value.toString()).millisecondsSinceEpoch / 1000)
                    .floor();
          } catch (e) {
            return '';
          }
