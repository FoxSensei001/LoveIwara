                    ...
                    children: [
                      ...
                      Obx(
                        () => SwitchListTile(
                          ...
                          value:
                              configService[ConfigKey.ENABLE_LOG_PERSISTENCE],
                          onChanged: (value) {
                            configService[ConfigKey.ENABLE_LOG_PERSISTENCE] =
                                value;
                      ...
                      Obx(
                        () => ListTile(
                          ...
                          subtitle: Text(
                            slang.t.log.logDatabaseSizeLimitDesc(
                              size: _formatSize(
                                configService[ConfigKey.MAX_LOG_DATABASE_SIZE],
                              ),
                            ),
                          ),
                          trailing: const Icon(
                          ...
                          onTap: () =>
                              _showLogSizeLimitDialog(context, configService),
                        ),
                      ),
                      ListTile(
                        ...
                        onTap: () async {
                          try {
                            ...
                            showToastWidget(
                              MDToastWidget(
                                message: slang.t.log.logExportFailed(
                                  error: e.toString(),
                                ),
                                type: MDToastType.error,
                              ),
                      ...
                      ListTile(
                        ...
                        onTap: () async {
                          try {
                            ...
                            showToastWidget(
                              MDToastWidget(
                                message: slang.t.log.logExtractFailed(
                                  error: e.toString(),
                                ),
                                type: MDToastType.error,
                              ),
                        ...
                        onTap: () async {
                          ...
                          final confirmed = await showDialog<bool>(
                            ...
                            builder: (context) => AlertDialog(
                              ...
                              content: Text(
                                slang.t.log.confirmClearAllLogsDesc,
                              ),
                              actions: [
                                TextButton(
                                  child: Text(slang.t.common.cancel),
                          ...
                          if (confirmed == true) {
                            try {
                              ...
                              showToastWidget(
                                MDToastWidget(
                                  message: slang.t.log.clearAllLogsFailed(
                                    error: e.toString(),
                                  ),
                                  type: MDToastType.error,
                                ),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Obx(
                        () => SwitchListTile(
                          title: Text(
                            slang.t.settings.useTraditionalPaginationMode,
                          ),
                          subtitle: Text(
...
/// 构建日志大小详情展示组件
Widget _buildLogSizeDetailWidget(
                          ...
                          child: Text(
                            rawUsageRatio >= 1.0
                                ? slang
                                      .t
                                      .log
                                      .currentLogSizeExceededPleaseCleanOldLogsOrIncreaseLogSizeLimit
                                : slang
                                      .t
                                      .log
                                      .currentLogSizeAlmostExceededPleaseCleanOldLogs,
                            style: TextStyle(
                              color: Colors.red.shade700,
                              fontSize: 12,
                            ),
                  ...
                  Padding(
                    ...
                    child: OutlinedButton(
                      onPressed: () async {
                        ...
                        bool cleaned = false;
                        try {
                          cleaned = await Get.find<LogService>()
                              .forceCheckAndCleanupBySize();
                        ...
                        if (context.mounted) {
                          // 使用刷新方式
                          final state = context
                              .findAncestorStateOfType<_AppSettingsPageState>();
                          if (state != null) {
                            ...
                            MDToastWidget(
                              message: cleaned
                                  ...
                                  : slang
                                        .t
                                        .log
                                        .logCleaningProcessMayNotBeCompleted,
                              type: cleaned
                                  ? MDToastType.success
                                  : MDToastType.warning,
                            ),
    ...
    if (GetPlatform.isDesktop) {
      ...
      if (context.mounted) {
        ...
        if (result != null && context.mounted) {
          ...
          await LogUtils.exportLogFileEnhanced(targetPath: result.path);
      ...
      // 将日志复制到临时目录
      await LogUtils.exportLogFileEnhanced(targetPath: tempFilePath);
        ...
        builder: (context, snapshot) {
          ...
          if (snapshot.hasError) {
            return AlertDialog(
              ...
              content: Text(
                slang.t.log.logExtractFailed(error: snapshot.error.toString()),
              ),
              actions: [
                TextButton(
...
/// 显示日志大小限制对话框
Future<void> _showLogSizeLimitDialog(
  BuildContext context,
  ConfigService configService,
) async {
  // 预设的大小选项（字节）
                ...
                onChanged: (value) async {
                  ...
                  if (currentLogSize > value) {
                      ...
                      builder: (context) => AlertDialog(
                        ...
                        content: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 12),
                            Text(
                              slang.t.log.currentLogSizeWithSize(
                                size: _formatSize(currentLogSize),
                              ),
                            ),
                            Text(
                              slang.t.log.newSizeLimit(
                                size: _formatSize(value),
                              ),
                            ),
                            const SizedBox(height: 12),
                            Text(
                    ...
                    if (context.mounted) {
                      showToastWidget(
                        MDToastWidget(
                          message: slang.t.log.logSizeLimitSetSuccess(
                            size: _formatSize(value),
                          ),
                          type: MDToastType.success,
                        ),
