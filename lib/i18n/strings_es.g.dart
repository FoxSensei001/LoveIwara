...
class _TranslationsCommonEs extends TranslationsCommonEn {
	...
	@override String get tapToReread => 'Toca para releer';
...
class _TranslationsSearchEs extends TranslationsSearchEn {
	...
	@override String get exactMatch => 'Exacto';
	@override String get exactMatchOnHint => 'Coincidencia exacta de la frase, buscando también en títulos en chino y japonés. Toca para una búsqueda más amplia.';
	@override String get exactMatchOffHint => 'Coincidencia laxa: Iwara separa las palabras. Toca para la frase exacta.';
	@override String get tagExpansion => 'Buscar también la etiqueta';
	@override String tagExpansionOnHint({required Object tags}) => 'Buscando también la etiqueta «${tags}» y sus nombres en japonés/inglés: muchas subidas no ponen tu palabra en el título.';
	@override String tagExpansionOffHint({required Object tags}) => 'Solo se buscan tus palabras. Actívalo para incluir la etiqueta «${tags}» y sus nombres en otros idiomas.';
...
class _TranslationsSettingsEs extends TranslationsSettingsEn {
	...
	@override String get signaturePreview => 'Vista previa';
	@override String get signatureSampleBody => 'Aquí va tu mensaje';
	@override String get signatureRegenerate => 'Regenerar';
	@override String get signatureNotSet => 'Sin configurar';
	@override String get signatureRuleHint => 'La firma se añade después del texto, separada por una línea horizontal. La app añade la línea; tú solo escribe lo de abajo.';
	@override String get signatureInsertVariable => 'Insertar variable';
	@override String get varDate => 'Fecha';
	@override String get varTime => 'Hora';
	@override String get varDatetime => 'Fecha y hora';
	@override String get varWeekday => 'Día de la semana';
	@override String get varPlatform => 'Plataforma';
	@override String get varPick => 'Frase al azar';
	@override String get varTitle => 'Título';
	@override String get varAuthor => 'Autor';
	@override String get varTags => 'Etiquetas';
	@override String get varSection => 'Sección';
	@override String get varReplyTo => 'Respondiendo a';
	@override String get varPlaytime => 'Posición de reproducción';
	@override String get signatureContextGroup => 'Variables de contexto';
	@override String get signatureContextHint => 'Los valores vienen de la página desde la que publicas: una página de vídeo conoce el título, el autor, las etiquetas y el punto de reproducción; el foro conoce la sección y el número de mensaje. A la derecha hay valores de ejemplo; lo que no se pueda rellenar desaparece al enviar.';
	@override String get signatureContextValue => 'Según la página';
	@override String get varFloor => 'Número de mensaje';
	@override String get varDuration => 'Duración del vídeo';
	@override String get signatureRecipesHint => '¿No sabes qué escribir? Toca uno para usarlo y luego edítalo. Lo que ves abajo es cómo quedará de verdad.';
	@override String get recipeWatchingName => 'Lo que estoy viendo';
	@override String get recipeWatchingTemplate => 'Viendo %title% · %date%';
	@override String get recipeTimestampName => 'Hasta dónde llegué';
	@override String get recipeTimestampTemplate => 'En %playtime% de %duration%';
	@override String get recipeHitokotoName => 'Frase del día';
	@override String get recipeHitokotoTemplate => 'Frase del día: %hitokoto%';
	@override String get recipeAiName => 'Que lo escriba la IA';
	@override String get recipeAiTemplate => '%ai_hitokoto%';
	@override String get recipeReplyName => 'Saludar al responder';
	@override String get recipeReplyTemplate => 'Para %reply_to% · enviado desde %platform%';
	@override String get recipeMoodName => 'Ánimo aleatorio';
	@override String get recipeMoodTemplate => 'Ánimo de hoy: %pick:genial|normal|mejor no preguntes%';
	@override String get signatureRecipesTitle => 'Ejemplos';
	@override String get signatureRecipesMore => 'Más ejemplos';
	@override String get signatureSceneVideo => 'En un vídeo';
	@override String get signatureSceneForum => 'En el foro';
	@override String get signatureSceneAuthor => 'En un perfil';
	@override String get signatureSceneNone => 'Sin contexto';
	@override String get signatureSceneFromHistory => 'El contenido de ejemplo viene de lo último que viste. Al publicar de verdad se usa la página en la que estés.';
	@override String get signatureSceneFromDemo => 'Aún no hay historial, así que se usa un ejemplo de relleno. Al publicar de verdad se usa la página en la que estés.';
	@override String get signatureDemoVideoTitle => 'Bailando a la luz de la luna';
	@override String get signatureDemoAuthor => 'Hoshino';
	@override String get signatureDemoTags => 'mmd 4k 60fps';
	@override String get signatureDemoThreadTitle => '¿Algún consejo para los ajustes de calidad?';
	@override String get signatureDemoSection => 'General';
	@override String get signatureDemoQuote => 'Despacio se llega antes.';
	@override String get signatureDemoAiQuote => 'Ese giro a los tres minutos y medio ya valía la pena.';
	@override String get signatureRecipeGroupWatching => 'Mientras ves algo';
	@override String get signatureRecipeGroupReplying => 'Al responder';
	...
	@override String get recipeFloorTemplate => 'Desde el mensaje %floor% · para %reply_to%';
	@override String get recipeSectionName => 'Decir la sección';
	@override String get recipeSectionTemplate => 'Desde %section%';
	@override String get recipeDailyName => 'Fecha y frase';
	@override String get recipeDailyTemplate => '%date% %weekday% · %hitokoto%';
	@override String get signatureSources => 'Fuentes de datos';
	@override String get signatureAutoTranslate => 'Traducir a mi idioma';
	@override String get signatureAutoTranslateDesc => 'Fuentes como Hitokoto solo ofrecen chino por ahora. La frase se traduce justo antes de enviarla.';
	@override String get signatureWizardTitle => 'Añadir una fuente';
	@override String get signatureWizardUrlTitle => 'Dirección del servicio';
	@override String get signatureWizardUrlHint => 'Indica una URL que devuelva una línea de texto. El botón de abajo la llama de verdad para que veas qué responde.';
	@override String get signatureWizardFetch => 'Consultar';
	@override String get signatureWizardSkipTest => 'Saltar y solo renombrar';
	@override String get signatureWizardPickTitle => 'Elige la parte que quieres';
	@override String get signatureWizardPickHint => 'Esto es lo que respondió ese servicio. Toca la línea que quieres que muestre tu firma.';
	@override String get signatureWizardPickPlainHint => 'Este servicio devolvió texto plano, así que se mostrará entero.';
	@override String get signatureWizardWholeBody => 'Toda la respuesta';
	@override String get signatureWizardNameTitle => 'Ponle un nombre';
	@override String get signatureWizardNameHint => 'El nombre es solo para ti. Lo que usa la firma es el nombre de referencia de abajo.';
	@override String get signatureWizardNext => 'Siguiente';
	@override String get signatureWizardDone => 'Hecho';
	@override String get signatureWizardStripHtml => 'Quitar etiquetas HTML';
	@override String get signatureWizardAdvanced => 'Avanzado: extraer con un patrón';
	@override String get signatureWizardExtractHint => 'Expresión regular; se usa el primer grupo de captura';
	@override String get signatureWizardExtractMissed => 'Ese patrón no coincidió, se deja el texto tal cual';
	@override String get signatureWizardChooseTitle => 'Elige una fuente';
	@override String get signatureWizardChooseHint => 'Toca una de las que ya vienen listas y ya está. O apunta a tu propio endpoint.';
	@override String get signatureWizardCustomSource => 'Usar mi propio endpoint';
	@override String get signatureWizardWithOrigin => 'Mostrar de dónde viene';
	@override String get signatureWizardRandomItem => 'Tomar una distinta cada vez';
	@override String get signatureWizardSuffixTitle => 'Añadir otro campo';
	@override String get signatureWizardSuffixNone => 'Nada';
	@override String get signatureOptFlavor => 'Contenido';
	@override String get signatureOptFlavorAny => 'Cualquiera';
	@override String get signatureOptFlavorOtaku => 'Anime, manga y juegos';
	@override String get signatureOptFlavorLiterary => 'Literatura y poesía';
	@override String get signatureOptFlavorMeme => 'Cultura de internet';
	@override String get signatureOptLength => 'Longitud';
	@override String get signatureOptLengthAny => 'Cualquiera';
	@override String get signatureOptLengthShort => 'Solo frases cortas';
	@override String get signatureRestoreDefault => 'Restaurar valores por defecto';
	@override String get signatureSourceHitokoto => 'Hitokoto (frase al azar)';
	@override String get signatureAiSourceName => 'Frase generada por IA';
	...
	@override String get signatureSourceIdReserved => 'Ese nombre ya es de una variable integrada';
	@override String get signatureSourcesTitle => 'Fuentes de datos propias';
	@override String get signatureSourcesHint => 'Indica una dirección que devuelva una línea de texto y podrás usarla en tu firma.';
	@override String get signatureSourcesEmpty => 'Todavía no hay fuentes';
	@override String get signatureAddSource => 'Añadir';
	@override String get signatureEditSource => 'Editar fuente';
	@override String get signatureSourceName => 'Nombre';
	@override String get signatureSourceId => 'Nombre de referencia';
	@override String get signatureSourceIdHint => 'El nombre con el que tu firma llama a esta fuente';
	@override String get signatureSourceUrl => 'URL del servicio';
	@override String get signatureSourcePath => 'Ruta del valor';
	@override String get signatureSourcePathHint => 'Déjalo vacío si toda la respuesta es el texto. Usa data.text para tomar ese campo de una respuesta JSON.';
	@override String get signatureSourceTest => 'Probar';
	@override String get signatureSourceTestOk => 'Conseguido';
	@override String get signatureSourceTestFailed => 'No llegó nada';
	@override String get signatureSourceIdInvalid => 'El nombre de referencia solo admite minúsculas, dígitos y guiones bajos';
	@override String get signatureSourceIdDuplicate => 'Ese nombre de referencia ya está en uso';
	@override String get signatureSourceUrlRequired => 'Hace falta una URL';
...
class _TranslationsForumEs extends TranslationsForumEn {
	...
	// Translations
	@override String get attachQuote => 'Adjuntar cita';
	@override String replyToFloor({required Object floor, required Object username}) => 'Responder a #${floor} @${username}';
	@override String get removeQuote => 'Quitar cita';
	...
	@override String get floorNotFound => 'Esa publicación ya no existe';
	@override String get floorNotLoadedYet => 'Esa publicación está más arriba: carga más respuestas para ir a ella';
...
class _TranslationsEmojiEs extends TranslationsEmojiEn {
	...
	// Translations
	@override String get recentlyUsed => 'Recientes';
	@override String insertedCount({required Object count}) => '${count} insertados';
...
// Path: ai
class _TranslationsAiEs extends TranslationsAiEn {
	...
	@override String get providersHint => 'Añade uno o más proveedores de IA y elige cuál usará cada función.';
	@override String get addProvider => 'Añadir proveedor';
	@override String get noProviders => 'Aún no hay proveedores. Añade uno para habilitar la traducción, búsqueda y firma con IA.';
	@override String get pickPreset => 'Elegir proveedor';
	@override String get providerNameLabel => 'Nombre';
	@override String get apiKey => 'Clave API';
	@override String get baseUrl => 'Punto de conexión';
	@override String get model => 'Modelo';
	@override String get modelPick => 'Elegir modelo';
	@override String get modelEmpty => 'No se pudo cargar la lista de modelos; escribir el nombre del modelo también funciona.';
	@override String get advanced => 'Avanzado';
	@override String get reasoning => 'Modelo de razonamiento';
	@override String get streaming => 'Salida en streaming';
	@override String get structuredOutput => 'Salida estructurada';
	@override String get structuredOutputHint => 'Necesario para la búsqueda con IA. Muchos puntos de retransmisión no lo admiten; desactívalo si la búsqueda sigue fallando.';
	@override String get temperature => 'Temperatura';
	@override String get maxTokens => 'Tokens máximos';
	@override String get maxTokensAuto => 'Automático (límite del modelo)';
	@override String get test => 'Probar';
	@override String get testOk => 'Conexión correcta';
	@override String get deleteProvider => 'Eliminar proveedor';
	@override String get usedBy => 'Usado por';
	@override String get taskBindings => 'Asignación de funciones';
	@override String get taskBindingsHint => 'Cada función puede usar un proveedor diferente.';
	@override String get taskTranslate => 'Traducción';
	@override String get taskSearch => 'Búsqueda con IA';
	@override String get taskSignature => 'Firma';
	@override String get taskAuto => 'Automático';
	@override String get usage => 'Uso';
	@override String get usageCalls => 'Llamadas';
	@override String get usageTokens => 'Tokens consumidos';
	@override String get usageFailures => 'Errores';
	@override String get usageReset => 'Borrar estadísticas';
	@override String get usageEmpty => 'Aún no hay llamadas';
	@override String get openSettings => 'Abrir ajustes de IA';
	@override String get notConfigured => 'No configurado';
	@override String get searchTitle => 'Búsqueda con IA';
	@override String get searchHint => 'Describe lo que buscas; la IA completará los términos de búsqueda y los filtros.';
	@override String get searchPlaceholder => 'p. ej. MMD recientes con más de 10.000 visitas';
	@override String get searchApply => 'Buscar con estos criterios';
	@override String get searchEmpty => 'No se pudieron obtener términos de búsqueda. Prueba a describirlo de otra forma.';
	@override String get searchFilters => 'Filtros';
	@override String searchSwitchSegment({required Object segment}) => 'Cambiar a ${segment}';
	@override String get searchGenerating => 'Pensando…';
	@override String get searchRetrying => 'El intento anterior falló, reintentando…';
	@override String searchRetryReason({required Object reason}) => 'Motivo: ${reason}';
	@override String get searchStageWaiting => 'Solicitud enviada, esperando respuesta…';
	@override String get searchStageThinkingNext => 'Pensando en el siguiente paso…';
	@override String get searchStageReasoning => 'Razonando…';
	@override String get searchStageTool => 'Probando una búsqueda…';
	@override String searchStageDrafting({required Object chars}) => 'Escribiendo la respuesta · ${chars} caracteres';
	@override String get searchStageParsing => 'Ordenando el resultado…';
	@override String get searchThinking => 'Razonamiento';
	@override String get searchKeywordNeedsQuotes => 'Esta palabra clave no está entrecomillada, así que Iwara la hace coincidir de forma laxa: con este orden la primera página será casi toda irrelevante. Ponla entre "comillas" u ordena por relevancia.';
	@override String searchToolProbing({required Object query}) => 'Probando ${query}';
	@override String searchToolFound({required Object count, required Object titles}) => '${count} resultados · ${titles}';
	@override String searchToolFailed({required Object reason}) => 'No se pudo: ${reason}';
	@override String searchToolFilterCount({required Object count}) => '${count} filtros';
	@override String searchToolExpanded({required Object tags}) => 'ampliado con ${tags}';
	@override String searchToolLookupTags({required Object terms}) => 'Buscando etiquetas ${terms}';
	@override String get searchToolTagMissing => 'no es etiqueta';
	@override String searchToolFindUser({required Object name}) => 'Buscando autor ${name}';
	@override String searchToolUsersFound({required Object count, required Object users}) => '${count} usuarios · ${users}';
	@override String get searchPlanTitle => 'Plan de búsqueda';
	@override String searchPlanEstimate({required Object count}) => 'Unos ${count} resultados';
	@override String searchToolCount({required Object count}) => '${count} consultas';
	@override String get searchWillExpandTags => 'También busca estas etiquetas';
	@override String get searchTraceReasoning => 'Razonamiento';
	@override String searchFiltersDropped({required Object count}) => 'Se han quitado ${count} filtros que no existen en esta sección.';
...
extension on TranslationsEs {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'common.tapToReread' => 'Toca para releer',
			...
			'search.exactMatch' => 'Exacto',
			'search.exactMatchOnHint' => 'Coincidencia exacta de la frase, buscando también en títulos en chino y japonés. Toca para una búsqueda más amplia.',
			'search.exactMatchOffHint' => 'Coincidencia laxa: Iwara separa las palabras. Toca para la frase exacta.',
			'search.tagExpansion' => 'Buscar también la etiqueta',
			'search.tagExpansionOnHint' => ({required Object tags}) => 'Buscando también la etiqueta «${tags}» y sus nombres en japonés/inglés: muchas subidas no ponen tu palabra en el título.',
			'search.tagExpansionOffHint' => ({required Object tags}) => 'Solo se buscan tus palabras. Actívalo para incluir la etiqueta «${tags}» y sus nombres en otros idiomas.',
			...
			'settings.signaturePreview' => 'Vista previa',
			'settings.signatureSampleBody' => 'Aquí va tu mensaje',
			'settings.signatureRegenerate' => 'Regenerar',
			'settings.signatureNotSet' => 'Sin configurar',
			'settings.signatureRuleHint' => 'La firma se añade después del texto, separada por una línea horizontal. La app añade la línea; tú solo escribe lo de abajo.',
			'settings.signatureInsertVariable' => 'Insertar variable',
			'settings.varDate' => 'Fecha',
			'settings.varTime' => 'Hora',
			'settings.varDatetime' => 'Fecha y hora',
			'settings.varWeekday' => 'Día de la semana',
			'settings.varPlatform' => 'Plataforma',
			'settings.varPick' => 'Frase al azar',
			'settings.varTitle' => 'Título',
			'settings.varAuthor' => 'Autor',
			'settings.varTags' => 'Etiquetas',
			'settings.varSection' => 'Sección',
			'settings.varReplyTo' => 'Respondiendo a',
			'settings.varPlaytime' => 'Posición de reproducción',
			'settings.signatureContextGroup' => 'Variables de contexto',
			'settings.signatureContextHint' => 'Los valores vienen de la página desde la que publicas: una página de vídeo conoce el título, el autor, las etiquetas y el punto de reproducción; el foro conoce la sección y el número de mensaje. A la derecha hay valores de ejemplo; lo que no se pueda rellenar desaparece al enviar.',
			'settings.signatureContextValue' => 'Según la página',
			'settings.varFloor' => 'Número de mensaje',
			'settings.varDuration' => 'Duración del vídeo',
			'settings.signatureRecipesHint' => '¿No sabes qué escribir? Toca uno para usarlo y luego edítalo. Lo que ves abajo es cómo quedará de verdad.',
			'settings.recipeWatchingName' => 'Lo que estoy viendo',
			'settings.recipeWatchingTemplate' => 'Viendo %title% · %date%',
			'settings.recipeTimestampName' => 'Hasta dónde llegué',
			'settings.recipeTimestampTemplate' => 'En %playtime% de %duration%',
			'settings.recipeHitokotoName' => 'Frase del día',
			'settings.recipeHitokotoTemplate' => 'Frase del día: %hitokoto%',
			'settings.recipeAiName' => 'Que lo escriba la IA',
			'settings.recipeAiTemplate' => '%ai_hitokoto%',
			'settings.recipeReplyName' => 'Saludar al responder',
			'settings.recipeReplyTemplate' => 'Para %reply_to% · enviado desde %platform%',
			'settings.recipeMoodName' => 'Ánimo aleatorio',
			'settings.recipeMoodTemplate' => 'Ánimo de hoy: %pick:genial|normal|mejor no preguntes%',
			'settings.signatureRecipesTitle' => 'Ejemplos',
			'settings.signatureRecipesMore' => 'Más ejemplos',
			'settings.signatureSceneVideo' => 'En un vídeo',
			'settings.signatureSceneForum' => 'En el foro',
			'settings.signatureSceneAuthor' => 'En un perfil',
			'settings.signatureSceneNone' => 'Sin contexto',
			'settings.signatureSceneFromHistory' => 'El contenido de ejemplo viene de lo último que viste. Al publicar de verdad se usa la página en la que estés.',
			'settings.signatureSceneFromDemo' => 'Aún no hay historial, así que se usa un ejemplo de relleno. Al publicar de verdad se usa la página en la que estés.',
			'settings.signatureDemoVideoTitle' => 'Bailando a la luz de la luna',
			'settings.signatureDemoAuthor' => 'Hoshino',
			'settings.signatureDemoTags' => 'mmd 4k 60fps',
			'settings.signatureDemoThreadTitle' => '¿Algún consejo para los ajustes de calidad?',
			'settings.signatureDemoSection' => 'General',
			'settings.signatureDemoQuote' => 'Despacio se llega antes.',
			'settings.signatureDemoAiQuote' => 'Ese giro a los tres minutos y medio ya valía la pena.',
			'settings.signatureRecipeGroupWatching' => 'Mientras ves algo',
			'settings.signatureRecipeGroupReplying' => 'Al responder',
			...
			'settings.recipeFloorTemplate' => 'Desde el mensaje %floor% · para %reply_to%',
			'settings.recipeSectionName' => 'Decir la sección',
			'settings.recipeSectionTemplate' => 'Desde %section%',
			'settings.recipeDailyName' => 'Fecha y frase',
			'settings.recipeDailyTemplate' => '%date% %weekday% · %hitokoto%',
			'settings.signatureSources' => 'Fuentes de datos',
			'settings.signatureAutoTranslate' => 'Traducir a mi idioma',
			'settings.signatureAutoTranslateDesc' => 'Fuentes como Hitokoto solo ofrecen chino por ahora. La frase se traduce justo antes de enviarla.',
			'settings.signatureWizardTitle' => 'Añadir una fuente',
			'settings.signatureWizardUrlTitle' => 'Dirección del servicio',
			'settings.signatureWizardUrlHint' => 'Indica una URL que devuelva una línea de texto. El botón de abajo la llama de verdad para que veas qué responde.',
			'settings.signatureWizardFetch' => 'Consultar',
			'settings.signatureWizardSkipTest' => 'Saltar y solo renombrar',
			'settings.signatureWizardPickTitle' => 'Elige la parte que quieres',
			'settings.signatureWizardPickHint' => 'Esto es lo que respondió ese servicio. Toca la línea que quieres que muestre tu firma.',
			'settings.signatureWizardPickPlainHint' => 'Este servicio devolvió texto plano, así que se mostrará entero.',
			'settings.signatureWizardWholeBody' => 'Toda la respuesta',
			'settings.signatureWizardNameTitle' => 'Ponle un nombre',
			'settings.signatureWizardNameHint' => 'El nombre es solo para ti. Lo que usa la firma es el nombre de referencia de abajo.',
			'settings.signatureWizardNext' => 'Siguiente',
			'settings.signatureWizardDone' => 'Hecho',
			'settings.signatureWizardStripHtml' => 'Quitar etiquetas HTML',
			'settings.signatureWizardAdvanced' => 'Avanzado: extraer con un patrón',
			'settings.signatureWizardExtractHint' => 'Expresión regular; se usa el primer grupo de captura',
			'settings.signatureWizardExtractMissed' => 'Ese patrón no coincidió, se deja el texto tal cual',
			'settings.signatureWizardChooseTitle' => 'Elige una fuente',
			'settings.signatureWizardChooseHint' => 'Toca una de las que ya vienen listas y ya está. O apunta a tu propio endpoint.',
			'settings.signatureWizardCustomSource' => 'Usar mi propio endpoint',
			'settings.signatureWizardWithOrigin' => 'Mostrar de dónde viene',
			'settings.signatureWizardRandomItem' => 'Tomar una distinta cada vez',
			'settings.signatureWizardSuffixTitle' => 'Añadir otro campo',
			'settings.signatureWizardSuffixNone' => 'Nada',
			'settings.signatureOptFlavor' => 'Contenido',
			'settings.signatureOptFlavorAny' => 'Cualquiera',
			'settings.signatureOptFlavorOtaku' => 'Anime, manga y juegos',
			'settings.signatureOptFlavorLiterary' => 'Literatura y poesía',
			'settings.signatureOptFlavorMeme' => 'Cultura de internet',
			'settings.signatureOptLength' => 'Longitud',
			'settings.signatureOptLengthAny' => 'Cualquiera',
			'settings.signatureOptLengthShort' => 'Solo frases cortas',
			'settings.signatureRestoreDefault' => 'Restaurar valores por defecto',
			'settings.signatureSourceHitokoto' => 'Hitokoto (frase al azar)',
			'settings.signatureAiSourceName' => 'Frase generada por IA',
			...
			'settings.signatureSourceIdReserved' => 'Ese nombre ya es de una variable integrada',
			'settings.signatureSourcesTitle' => 'Fuentes de datos propias',
			'settings.signatureSourcesHint' => 'Indica una dirección que devuelva una línea de texto y podrás usarla en tu firma.',
			'settings.signatureSourcesEmpty' => 'Todavía no hay fuentes',
			'settings.signatureAddSource' => 'Añadir',
			'settings.signatureEditSource' => 'Editar fuente',
			'settings.signatureSourceName' => 'Nombre',
			'settings.signatureSourceId' => 'Nombre de referencia',
			'settings.signatureSourceIdHint' => 'El nombre con el que tu firma llama a esta fuente',
			'settings.signatureSourceUrl' => 'URL del servicio',
			'settings.signatureSourcePath' => 'Ruta del valor',
			'settings.signatureSourcePathHint' => 'Déjalo vacío si toda la respuesta es el texto. Usa data.text para tomar ese campo de una respuesta JSON.',
			'settings.signatureSourceTest' => 'Probar',
			'settings.signatureSourceTestOk' => 'Conseguido',
			'settings.signatureSourceTestFailed' => 'No llegó nada',
			'settings.signatureSourceIdInvalid' => 'El nombre de referencia solo admite minúsculas, dígitos y guiones bajos',
			'settings.signatureSourceIdDuplicate' => 'Ese nombre de referencia ya está en uso',
			'settings.signatureSourceUrlRequired' => 'Hace falta una URL',
			...
			'forum.attachQuote' => 'Adjuntar cita',
			'forum.replyToFloor' => ({required Object floor, required Object username}) => 'Responder a #${floor} @${username}',
			'forum.removeQuote' => 'Quitar cita',
			...
			'forum.floorNotFound' => 'Esa publicación ya no existe',
			'forum.floorNotLoadedYet' => 'Esa publicación está más arriba: carga más respuestas para ir a ella',
			...
			'emoji.recentlyUsed' => 'Recientes',
			'emoji.insertedCount' => ({required Object count}) => '${count} insertados',
			'emoji.name' => 'Emoji',
			'emoji.size' => 'Tamaño',
			'emoji.small' => 'Pequeño',
			...
			'ai.providersHint' => 'Añade uno o más proveedores de IA y elige cuál usará cada función.',
			'ai.addProvider' => 'Añadir proveedor',
			'ai.noProviders' => 'Aún no hay proveedores. Añade uno para habilitar la traducción, búsqueda y firma con IA.',
			'ai.pickPreset' => 'Elegir proveedor',
			'ai.providerNameLabel' => 'Nombre',
			'ai.apiKey' => 'Clave API',
			'ai.baseUrl' => 'Punto de conexión',
			'ai.model' => 'Modelo',
			...
			'ai.structuredOutputHint' => 'Necesario para la búsqueda con IA. Muchos puntos de retransmisión no lo admiten; desactívalo si la búsqueda sigue fallando.',
			'ai.temperature' => 'Temperatura',
			'ai.maxTokens' => 'Tokens máximos',
			'ai.maxTokensAuto' => 'Automático (límite del modelo)',
			'ai.test' => 'Probar',
			'ai.testOk' => 'Conexión correcta',
			'ai.deleteProvider' => 'Eliminar proveedor',
			'ai.usedBy' => 'Usado por',
			'ai.taskBindings' => 'Asignación de funciones',
			'ai.taskBindingsHint' => 'Cada función puede usar un proveedor diferente.',
			...
			'ai.usageReset' => 'Borrar estadísticas',
			'ai.usageEmpty' => 'Aún no hay llamadas',
			...
			'ai.searchEmpty' => 'No se pudieron obtener términos de búsqueda. Prueba a describirlo de otra forma.',
			'ai.searchFilters' => 'Filtros',
			'ai.searchSwitchSegment' => ({required Object segment}) => 'Cambiar a ${segment}',
			'ai.searchGenerating' => 'Pensando…',
			'ai.searchRetrying' => 'El intento anterior falló, reintentando…',
			'ai.searchRetryReason' => ({required Object reason}) => 'Motivo: ${reason}',
			'ai.searchStageWaiting' => 'Solicitud enviada, esperando respuesta…',
			'ai.searchStageThinkingNext' => 'Pensando en el siguiente paso…',
			'ai.searchStageReasoning' => 'Razonando…',
			'ai.searchStageTool' => 'Probando una búsqueda…',
			'ai.searchStageDrafting' => ({required Object chars}) => 'Escribiendo la respuesta · ${chars} caracteres',
			'ai.searchStageParsing' => 'Ordenando el resultado…',
			'ai.searchThinking' => 'Razonamiento',
			'ai.searchKeywordNeedsQuotes' => 'Esta palabra clave no está entrecomillada, así que Iwara la hace coincidir de forma laxa: con este orden la primera página será casi toda irrelevante. Ponla entre "comillas" u ordena por relevancia.',
			'ai.searchToolProbing' => ({required Object query}) => 'Probando ${query}',
			'ai.searchToolFound' => ({required Object count, required Object titles}) => '${count} resultados · ${titles}',
			'ai.searchToolFailed' => ({required Object reason}) => 'No se pudo: ${reason}',
			'ai.searchToolFilterCount' => ({required Object count}) => '${count} filtros',
			'ai.searchToolExpanded' => ({required Object tags}) => 'ampliado con ${tags}',
			'ai.searchToolLookupTags' => ({required Object terms}) => 'Buscando etiquetas ${terms}',
			'ai.searchToolTagMissing' => 'no es etiqueta',
			'ai.searchToolFindUser' => ({required Object name}) => 'Buscando autor ${name}',
			'ai.searchToolUsersFound' => ({required Object count, required Object users}) => '${count} usuarios · ${users}',
			'ai.searchPlanTitle' => 'Plan de búsqueda',
			'ai.searchPlanEstimate' => ({required Object count}) => 'Unos ${count} resultados',
			'ai.searchToolCount' => ({required Object count}) => '${count} consultas',
			'ai.searchWillExpandTags' => 'También busca estas etiquetas',
			'ai.searchTraceReasoning' => 'Razonamiento',
			'ai.searchFiltersDropped' => ({required Object count}) => 'Se han quitado ${count} filtros que no existen en esta sección.',
			'ai.revealKey' => 'Show',
			'ai.hideKey' => 'Hide',
