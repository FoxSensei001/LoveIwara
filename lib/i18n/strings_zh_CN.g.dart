...
class _TranslationsSettingsZhCn implements TranslationsSettingsEn {
	...
	@override String get glassEffectDesc => '决定全局玻璃控件（顶栏胶囊、菜单、弹窗按钮）用哪种材质；浮动底栏始终是液态玻璃';
	...
	@override String get glassEffectIntroContent => '这一版的顶栏、底栏和菜单换成了液态玻璃（真实的模糊与折射）。如果设备上觉得卡或更喜欢简洁，可以现在换成轻量半透明（底栏会保持液态）。';
...
extension on TranslationsZhCn {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'settings.glassEffectDesc' => '决定全局玻璃控件（顶栏胶囊、菜单、弹窗按钮）用哪种材质；浮动底栏始终是液态玻璃',
			...
			'settings.glassEffectIntroContent' => '这一版的顶栏、底栏和菜单换成了液态玻璃（真实的模糊与折射）。如果设备上觉得卡或更喜欢简洁，可以现在换成轻量半透明（底栏会保持液态）。',
