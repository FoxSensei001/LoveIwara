...
class _TranslationsSearchDe extends TranslationsSearchEn {
	...
	@override String get tagExpansion => 'Auch nach Tag suchen';
	@override String tagExpansionOnHint({required Object tags}) => 'Sucht zusätzlich nach dem Tag „${tags}“ und seinen japanischen/englischen Namen – viele Uploads nennen dein Wort nicht im Titel.';
	@override String tagExpansionOffHint({required Object tags}) => 'Sucht nur nach deinen Wörtern. Einschalten, um auch nach dem Tag „${tags}“ und seinen Namen in anderen Sprachen zu suchen.';
...
class _TranslationsAiDe extends TranslationsAiEn {
	...
	@override String searchToolExpanded({required Object tags}) => 'ergänzt um ${tags}';
	@override String searchToolLookupTags({required Object terms}) => 'Suche Tags ${terms}';
	@override String get searchToolTagMissing => 'kein Tag';
	@override String searchToolFindUser({required Object name}) => 'Suche Autor ${name}';
	@override String searchToolUsersFound({required Object count, required Object users}) => '${count} Nutzer · ${users}';
	@override String get searchPlanTitle => 'Suchplan';
	@override String searchPlanEstimate({required Object count}) => 'Etwa ${count} Treffer';
	@override String searchToolCount({required Object count}) => '${count} Abfragen';
	@override String get searchWillExpandTags => 'Sucht auch nach diesen Tags';
	@override String get searchTraceReasoning => 'Überlegung';
...
extension on TranslationsDe {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'search.tagExpansion' => 'Auch nach Tag suchen',
			'search.tagExpansionOnHint' => ({required Object tags}) => 'Sucht zusätzlich nach dem Tag „${tags}“ und seinen japanischen/englischen Namen – viele Uploads nennen dein Wort nicht im Titel.',
			'search.tagExpansionOffHint' => ({required Object tags}) => 'Sucht nur nach deinen Wörtern. Einschalten, um auch nach dem Tag „${tags}“ und seinen Namen in anderen Sprachen zu suchen.',
			...
			'ai.searchToolExpanded' => ({required Object tags}) => 'ergänzt um ${tags}',
			'ai.searchToolLookupTags' => ({required Object terms}) => 'Suche Tags ${terms}',
			'ai.searchToolTagMissing' => 'kein Tag',
			'ai.searchToolFindUser' => ({required Object name}) => 'Suche Autor ${name}',
			'ai.searchToolUsersFound' => ({required Object count, required Object users}) => '${count} Nutzer · ${users}',
			'ai.searchPlanTitle' => 'Suchplan',
			'ai.searchPlanEstimate' => ({required Object count}) => 'Etwa ${count} Treffer',
			'ai.searchToolCount' => ({required Object count}) => '${count} Abfragen',
			'ai.searchWillExpandTags' => 'Sucht auch nach diesen Tags',
			'ai.searchTraceReasoning' => 'Überlegung',
