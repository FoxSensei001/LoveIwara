...
class TranslationsZhTw extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override late final _TranslationsAiZhTw ai = _TranslationsAiZhTw._(_root);
}

// Path: personalProfile
class _TranslationsPersonalProfileZhTw extends TranslationsPersonalProfileEn {
	_TranslationsPersonalProfileZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
// Path: tutorial
class _TranslationsTutorialZhTw extends TranslationsTutorialEn {
	_TranslationsTutorialZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
class _TranslationsCommonZhTw extends TranslationsCommonEn {
	...
	@override String get privacyHint => '隱私模式已開啟，內容不予展示';
...
// Path: friends
class _TranslationsFriendsZhTw extends TranslationsFriendsEn {
	_TranslationsFriendsZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
// Path: authorProfile
class _TranslationsAuthorProfileZhTw extends TranslationsAuthorProfileEn {
	_TranslationsAuthorProfileZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
// Path: galleryDetail
class _TranslationsGalleryDetailZhTw extends TranslationsGalleryDetailEn {
	_TranslationsGalleryDetailZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
// Path: mediaList
class _TranslationsMediaListZhTw extends TranslationsMediaListEn {
	_TranslationsMediaListZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsZhTw extends TranslationsSettingsEn {
	...
	@override String get showFullscreenUpNextHint => '顯示「接著看」入口';
	@override String get showFullscreenUpNextHintDesc => '在播放器右緣顯示一枚把手，用來開啟影片池抽屜（來源 / 播放清單 / 稍後再看）。關掉之後就沒有其他入口了。';
	...
	@override String get glassEffectIntroContent => '現在頂欄、底欄與選單用的是液態玻璃（真實的模糊與折射）。若在裝置上覺得卡頓或偏好簡潔，可以現在換成 Material（不透明、無模糊、無陰影）。';
	@override String get glassEffectIntroHint => '之後隨時可以在「設定 → 主題設定 → 介面材質」裡修改。';
	...
	@override String get signatureRegenerate => '換一句';
	...
	@override String get languageNativeName => '繁體中文';
	@override String get followSystemLanguage => '跟隨系統';
	@override String get languageChangedMessage => '語言切換成功，部分功能需重啟應用生效';
...
// Path: favoriteTags
class _TranslationsFavoriteTagsZhTw extends TranslationsFavoriteTagsEn {
	_TranslationsFavoriteTagsZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
// Path: oreno3d
class _TranslationsOreno3dZhTw extends TranslationsOreno3dEn {
	_TranslationsOreno3dZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
// Path: firstTimeSetup
class _TranslationsFirstTimeSetupZhTw extends TranslationsFirstTimeSetupEn {
	_TranslationsFirstTimeSetupZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
// Path: proxyHelper
class _TranslationsProxyHelperZhTw extends TranslationsProxyHelperEn {
	_TranslationsProxyHelperZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
// Path: signIn
class _TranslationsSignInZhTw extends TranslationsSignInEn {
	_TranslationsSignInZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
// Path: subscriptions
class _TranslationsSubscriptionsZhTw extends TranslationsSubscriptionsEn {
	_TranslationsSubscriptionsZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
// Path: videoDetail
class _TranslationsVideoDetailZhTw extends TranslationsVideoDetailEn {
	_TranslationsVideoDetailZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
// Path: share
class _TranslationsShareZhTw extends TranslationsShareEn {
	_TranslationsShareZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
// Path: markdown
class _TranslationsMarkdownZhTw extends TranslationsMarkdownEn {
	_TranslationsMarkdownZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
// Path: forum
class _TranslationsForumZhTw extends TranslationsForumEn {
	_TranslationsForumZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
	...
	@override String get floorNotFound => '該樓層不存在或已被刪除';
	@override String get floorNotLoadedYet => '該樓層在更早的位置，繼續向上載入後才能跳轉';
...
// Path: conversation
class _TranslationsConversationZhTw extends TranslationsConversationEn {
	_TranslationsConversationZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
// Path: splash
class _TranslationsSplashZhTw extends TranslationsSplashEn {
...
class _TranslationsDownloadNotificationsZhTw extends TranslationsDownloadNotificationsEn {
	_TranslationsDownloadNotificationsZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
// Path: favorite
class _TranslationsFavoriteZhTw extends TranslationsFavoriteEn {
	_TranslationsFavoriteZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
// Path: translation
class _TranslationsTranslationZhTw extends TranslationsTranslationEn {
	_TranslationsTranslationZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
// Path: mediaPlayer
class _TranslationsMediaPlayerZhTw extends TranslationsMediaPlayerEn {
	_TranslationsMediaPlayerZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
	...
	@override String unableToPlayNasVideo({required Object error}) => '無法播放 NAS 上的影片：${error}';
...
// Path: diagnostics
class _TranslationsDiagnosticsZhTw extends TranslationsDiagnosticsEn {
	_TranslationsDiagnosticsZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
// Path: logViewer
class _TranslationsLogViewerZhTw extends TranslationsLogViewerEn {
	_TranslationsLogViewerZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
class _TranslationsCrashRecoveryDialogZhTw extends TranslationsCrashRecoveryDialogEn {
	_TranslationsCrashRecoveryDialogZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
class _TranslationsLinkInputDialogZhTw extends TranslationsLinkInputDialogEn {
	_TranslationsLinkInputDialogZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
// Path: log
class _TranslationsLogZhTw extends TranslationsLogEn {
	_TranslationsLogZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
// Path: emoji
class _TranslationsEmojiZhTw extends TranslationsEmojiEn {
	_TranslationsEmojiZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
class _TranslationsDisplaySettingsZhTw extends TranslationsDisplaySettingsEn {
	_TranslationsDisplaySettingsZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
// Path: layoutSettings
class _TranslationsLayoutSettingsZhTw extends TranslationsLayoutSettingsEn {
	_TranslationsLayoutSettingsZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
// Path: bottomNav
class _TranslationsBottomNavZhTw extends TranslationsBottomNavEn {
	_TranslationsBottomNavZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
class _TranslationsNavigationOrderSettingsZhTw extends TranslationsNavigationOrderSettingsEn {
	_TranslationsNavigationOrderSettingsZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
// Path: news
class _TranslationsNewsZhTw extends TranslationsNewsEn {
	_TranslationsNewsZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
// Path: searchFilter
class _TranslationsSearchFilterZhTw extends TranslationsSearchFilterEn {
	_TranslationsSearchFilterZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
// Path: tagSelector
class _TranslationsTagSelectorZhTw extends TranslationsTagSelectorEn {
	_TranslationsTagSelectorZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
// Path: anime4k
class _TranslationsAnime4kZhTw extends TranslationsAnime4kEn {
	_TranslationsAnime4kZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
	...
	@override String get compatibilityTip => '⚠️ 部分行動裝置 GPU（如麒麟 980 / Mali-G76）無法渲染任何自訂著色器。若開啟後出現「有聲音但畫面全黑」，請在此關閉 Anime4K。';
	@override String get autoDisabledOnRenderFailure => '目前裝置 GPU 無法渲染 Anime4K 著色器，已自動關閉。';
}

// Path: siteMode
class _TranslationsSiteModeZhTw extends TranslationsSiteModeEn {
	_TranslationsSiteModeZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
class _TranslationsSavedSearchConfigZhTw extends TranslationsSavedSearchConfigEn {
	_TranslationsSavedSearchConfigZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
// Path: savedSearch
class _TranslationsSavedSearchZhTw extends TranslationsSavedSearchEn {
	_TranslationsSavedSearchZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
class _TranslationsDefaultBlacklistReminderZhTw extends TranslationsDefaultBlacklistReminderEn {
	_TranslationsDefaultBlacklistReminderZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
class _TranslationsColorVisionAssistZhTw extends TranslationsColorVisionAssistEn {
	_TranslationsColorVisionAssistZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
// Path: externalPlayer
class _TranslationsExternalPlayerZhTw extends TranslationsExternalPlayerEn {
	_TranslationsExternalPlayerZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);

	final TranslationsZhTw _root; // ignore: unused_field

	// Translations
	@override String get title => '用其他應用程式開啟';
	@override String get description => '把目前影片交給本機的其它播放器，例如 VR 頭顯上的 Skybox、Pigasus，手機上的 MX Player、VLC';
	@override String get openWithOtherApp => '選擇其他應用程式開啟';
	@override String get openWithOtherAppDescription => '彈出系統選擇器，挑一個播放器接手';
	@override String get openWithSystemPlayer => '用系統預設播放器開啟';
	@override String get openWithSystemPlayerDescription => '交給系統關聯的預設影片程式';
	@override String get copyLink => '複製影片連結';
	@override String get copyLinkDescription => '給只能貼上連結的播放器用，例如 Skybox、DeoVR';
	@override String get linkCopied => '影片連結已複製';
	@override String get sourceLocal => '本機檔案';
	@override String get sourceOnline => '線上直連';
	@override String sourceOnlineWithQuality({required Object quality}) => '線上直連 · ${quality}';
	@override String get onlineLinkExpiryHint => '線上直連有時效，外部播放器可能播到一半失效；先下載再轉交最穩';
	@override String get vrPlayerHint => 'VR 播放器沒出現在選擇器裡的話，用「複製影片連結」再到播放器內貼上開啟';
	@override String get noHandler => '找不到能開啟影片的應用程式';
	@override String handoffFailed({required Object message}) => '轉交失敗：${message}';
	@override String get handoffFailedUnknown => '轉交失敗';
	@override String get sourceUnavailable => '拿不到目前影片的位址，請稍後重試';
	@override String get localFileMissing => '本機檔案不存在，可能已被刪除';
	...
	@override String get detecting => '偵測中…';
	@override String detectFound({required Object count}) => '偵測到 ${count} 個播放器';
	@override String get detectNothingFound => '沒有偵測到新的播放器，可以手動新增';
	@override String get autoDetectedTag => '自動偵測';
	@override String get addPlayer => '新增播放器';
	@override String get editPlayer => '編輯播放器';
	@override String get playerName => '名稱';
	@override String get executablePath => '可執行檔';
	@override String get browse => '瀏覽';
	@override String get argumentTemplate => '啟動參數';
	@override String get argumentTemplateHint => '用 {input} 代表影片路徑或連結；留空就是把它當唯一參數傳給播放器';
	@override String get nameAndPathRequired => '名稱和可執行檔都不能為空';
	@override String get testLaunch => '測試啟動';
	@override String get testLaunched => '播放器已啟動';
	@override String get testFailed => '啟動失敗，請檢查可執行檔路徑';
	@override String get executableMissing => '可執行檔不存在';
	@override String openWithNamed({required Object name}) => '用 ${name} 開啟';
	@override String get managePlayersEntry => '管理外部播放器…';
}

// Path: watchLater
class _TranslationsWatchLaterZhTw extends TranslationsWatchLaterEn {
	_TranslationsWatchLaterZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);

	final TranslationsZhTw _root; // ignore: unused_field

	// Translations
	@override String get title => '稍後再看';
	@override String get addToWatchLater => '稍後再看';
	@override String get removeFromWatchLater => '移出稍後再看';
	...
	@override String watchedCleared({required Object count}) => '已清除 ${count} 筆看完的內容';
	@override String get noWatchedToClear => '沒有已看完的內容';
	@override String get emptyVideo => '還沒有加入稍後再看的影片';
	@override String get emptyGallery => '還沒有加入稍後再看的圖庫';
	@override String get filterAll => '全部';
	@override String get filterUnwatched => '未看完';
	@override String get sortRecentlyAdded => '最近加入';
	@override String get sortEarliestAdded => '最早加入';
	@override String get watched => '已看完';
	@override String get playlistLoadFailed => '播放清單載入失敗';
	@override String get noPlaylists => '還沒有播放清單';
	@override String get undo => '復原';
	@override String get clearWatchedConfirm => '要清除這個分類下所有已看完的內容嗎？此操作無法復原。';
	@override String get emptyUnwatchedVideo => '沒有未看完的影片';
	@override String get emptyUnwatchedGallery => '沒有未看完的圖庫';
	@override String get queueLoadFailed => '載入失敗，點擊重試';
}

// Path: mediaMenu
class _TranslationsMediaMenuZhTw extends TranslationsMediaMenuEn {
	_TranslationsMediaMenuZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
	...
	@override String get viewAuthor => '檢視作者主頁';
...
// Path: mediaPreview
class _TranslationsMediaPreviewZhTw extends TranslationsMediaPreviewEn {
	_TranslationsMediaPreviewZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
// Path: playbackQueue
class _TranslationsPlaybackQueueZhTw extends TranslationsPlaybackQueueEn {
	_TranslationsPlaybackQueueZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
	...
	@override String get openQueue => '接著看';
...
// Path: vrFormat
class _TranslationsVrFormatZhTw extends TranslationsVrFormatEn {
	_TranslationsVrFormatZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
	...
	@override String get panelSettingsDesc => '這塊應用面板放多遠，背後透出多少真實房間';
	@override String get panelDistance => '面板距離';
	@override String panelDistanceValue({required Object meters}) => '${meters} 公尺';
	@override String get panelResetPlacement => '重設位置';
	@override String get panelResetBackground => '恢復預設';
	@override String get panelBackground => '背景不透明度';
	@override String get panelBackgroundHint => '0%：純黑環境，只剩畫面 · 100%：環境光下的真實房間';
	@override String get panelUnavailable => '面板此刻不在場，稍後再試';
...
// Path: localMedia
class _TranslationsLocalMediaZhTw extends TranslationsLocalMediaEn {
	_TranslationsLocalMediaZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
	...
	@override String get scanQueued => '排隊等待掃描';
	@override String get itemInfo => '檔案資訊';
	@override String get revealInFolder => '在資料夾中顯示';
	@override String get rescanAll => '全部重新掃描';
	...
	@override String get addSource => '新增來源';
	@override String get addSourceKinds => '資料夾 · NAS';
	@override String get openSettings => '去設定開啟';
	@override String removeSourceLoses({required Object items}) => '以下內容會一起清除，重新新增也找不回來：${items}';
	@override String loseProgress({required Object count}) => '${count} 筆觀看進度';
	@override String loseFavorites({required Object count}) => '${count} 個精選';
	@override String losePinned({required Object count}) => '${count} 個常用目錄';
	@override String loseHidden({required Object count}) => '${count} 個隱藏設定';
	@override String loseCovers({required Object count}) => '${count} 張手選封面';
	@override String get renameSource => '重新命名';
	@override String get renameSourceTitle => '重新命名來源';
	@override String get renameSourceLabel => '名稱';
	@override String get renamed => '已重新命名';
	@override String get nasAggregateHint => 'NAS 上的內容只收錄開啟過的資料夾。沒開啟過的資料夾，裡面的影片和圖片不會出現在這裡。';
	@override String rescanDone({required Object name}) => '「${name}」已更新';
	@override String get unknownSourceHint => '這個來源需要更新版本的應用才能使用';
	@override late final _TranslationsLocalMediaMissingZhTw missing = _TranslationsLocalMediaMissingZhTw._(_root);
	@override late final _TranslationsLocalMediaWebdavZhTw webdav = _TranslationsLocalMediaWebdavZhTw._(_root);
	...
	@override String get permissionDenied => '未授予檔案存取權限，新增資料夾前需要先開啟';
	@override String get noVideosFound => '這個資料夾裡沒有影片';
	@override String get emptyTitle => '新增資料夾或連接 NAS，看你已有的影片';
	@override String get emptyPrivacyNote => '只在本機讀取，不上傳任何東西。';
	@override String removeSourceTitle({required Object name}) => '移除「${name}」？';
	@override String get removeSourceBody => '檔案本身一個不動，只是把它從本機媒體庫移出去。';
	@override String get remove => '移除';
	@override String get removeFolder => '移除來源';
	@override String get removeFolderSelectTitle => '選擇要移除的來源';
...
// Path: ai
class _TranslationsAiZhTw extends TranslationsAiEn {
	_TranslationsAiZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);

	final TranslationsZhTw _root; // ignore: unused_field

	// Translations
	@override String get title => 'AI';
	@override String get providers => '供應商';
	@override String get providersHint => '新增一個或多個 AI 供應商，再為每項功能指定用哪一個。';
	@override String get addProvider => '新增供應商';
	@override String get noProviders => '還沒有供應商。新增一個之後，翻譯、搜尋和小尾巴才能用上 AI。';
	@override String get pickPreset => '選擇供應商';
	@override String get providerNameLabel => '名稱';
	@override String get apiKey => 'API 金鑰';
	@override String get baseUrl => '端點位址';
	@override String get model => '模型';
	@override String get modelPick => '選擇模型';
	@override String get modelEmpty => '沒抓到模型列表，直接填模型名也可以';
	@override String get advanced => '進階';
	@override String get reasoning => '推理模型';
	@override String get streaming => '串流輸出';
	@override String get structuredOutput => '結構化輸出';
	@override String get structuredOutputHint => 'AI 搜尋要用它。不少中轉端點並不支援，搜尋老是失敗就關掉。';
	@override String get temperature => '溫度';
	@override String get maxTokens => '最大 token';
	@override String get maxTokensAuto => '自動（模型上限）';
	@override String get test => '測試';
	@override String get testOk => '連線正常';
	@override String get deleteProvider => '刪除供應商';
	@override String get usedBy => '正在用於';
	@override String get taskBindings => '功能分配';
	@override String get taskBindingsHint => '每項功能可以指定不同的供應商。';
	@override String get taskTranslate => '翻譯';
	@override String get taskSearch => 'AI 搜尋';
	@override String get taskSignature => '小尾巴';
	@override String get taskAuto => '自動';
	@override String get usage => '用量';
	@override String get usageCalls => '呼叫';
	@override String get usageTokens => 'token';
	@override String get usageFailures => '失敗';
	@override String get usageReset => '清空統計';
	@override String get usageEmpty => '還沒有呼叫紀錄';
	@override String get openSettings => '前往 AI 設定';
	@override String get notConfigured => '未設定';
	@override String get searchTitle => 'AI 搜尋';
	@override String get searchHint => '用一句話描述你想找什麼，AI 會替你填好搜尋詞和篩選條件。';
	@override String get searchPlaceholder => '例如：播放量破萬的最新 MMD';
	@override String get searchApply => '用這些條件搜尋';
	@override String get searchEmpty => '沒能從這句話裡解析出搜尋條件，換個說法試試';
	@override String get searchFilters => '篩選條件';
	@override String searchSwitchSegment({required Object segment}) => '切換到「${segment}」';
	@override String get searchGenerating => '正在理解…';
	@override String get searchRetrying => '上一次失敗了，正在重試…';
	@override String searchRetryReason({required Object reason}) => '失敗原因：${reason}';
	@override String get searchStageWaiting => '已送出請求，等待回應…';
	@override String get searchStageThinkingNext => '正在繼續思考…';
	@override String get searchStageReasoning => '正在推理…';
	@override String get searchStageTool => '正在試搜…';
	@override String searchStageDrafting({required Object chars}) => '正在寫答案 · 已 ${chars} 字';
	@override String get searchStageParsing => '正在整理結果…';
...
class _TranslationsCommonPaginationZhTw extends TranslationsCommonPaginationEn {
	_TranslationsCommonPaginationZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
// Path: errors.network
class _TranslationsErrorsNetworkZhTw extends TranslationsErrorsNetworkEn {
	_TranslationsErrorsNetworkZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsForumSettingsZhTw extends TranslationsSettingsForumSettingsEn {
	_TranslationsSettingsForumSettingsZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsGallerySettingsZhTw extends TranslationsSettingsGallerySettingsEn {
	_TranslationsSettingsGallerySettingsZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsBlockSettingsZhTw extends TranslationsSettingsBlockSettingsEn {
	_TranslationsSettingsBlockSettingsZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsChatSettingsZhTw extends TranslationsSettingsChatSettingsEn {
	_TranslationsSettingsChatSettingsZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsDownloadSettingsZhTw extends TranslationsSettingsDownloadSettingsEn {
	_TranslationsSettingsDownloadSettingsZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
class _TranslationsOreno3dSortTypesZhTw extends TranslationsOreno3dSortTypesEn {
	_TranslationsOreno3dSortTypesZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
// Path: oreno3d.errors
class _TranslationsOreno3dErrorsZhTw extends TranslationsOreno3dErrorsEn {
	_TranslationsOreno3dErrorsZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
class _TranslationsOreno3dLoadingZhTw extends TranslationsOreno3dLoadingEn {
	_TranslationsOreno3dLoadingZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
class _TranslationsOreno3dMessagesZhTw extends TranslationsOreno3dMessagesEn {
	_TranslationsOreno3dMessagesZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
class _TranslationsFirstTimeSetupWelcomeZhTw extends TranslationsFirstTimeSetupWelcomeEn {
	_TranslationsFirstTimeSetupWelcomeZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
class _TranslationsFirstTimeSetupBasicZhTw extends TranslationsFirstTimeSetupBasicEn {
	_TranslationsFirstTimeSetupBasicZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
class _TranslationsFirstTimeSetupNetworkZhTw extends TranslationsFirstTimeSetupNetworkEn {
	_TranslationsFirstTimeSetupNetworkZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
class _TranslationsFirstTimeSetupThemeZhTw extends TranslationsFirstTimeSetupThemeEn {
	_TranslationsFirstTimeSetupThemeZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
class _TranslationsFirstTimeSetupPlayerZhTw extends TranslationsFirstTimeSetupPlayerEn {
	_TranslationsFirstTimeSetupPlayerZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
class _TranslationsFirstTimeSetupSpatialZhTw extends TranslationsFirstTimeSetupSpatialEn {
	_TranslationsFirstTimeSetupSpatialZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
class _TranslationsFirstTimeSetupCompletionZhTw extends TranslationsFirstTimeSetupCompletionEn {
	_TranslationsFirstTimeSetupCompletionZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
class _TranslationsFirstTimeSetupCommonZhTw extends TranslationsFirstTimeSetupCommonEn {
	_TranslationsFirstTimeSetupCommonZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
class _TranslationsVideoDetailLocalInfoZhTw extends TranslationsVideoDetailLocalInfoEn {
	_TranslationsVideoDetailLocalInfoZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
class _TranslationsVideoDetailGestureGuideZhTw extends TranslationsVideoDetailGestureGuideEn {
	_TranslationsVideoDetailGestureGuideZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);

	final TranslationsZhTw _root; // ignore: unused_field

	// Translations
	@override String get sampleVideo => '範例影片';
	...
	@override late final _TranslationsVideoDetailGestureGuideQuestZhTw quest = _TranslationsVideoDetailGestureGuideQuestZhTw._(_root);
}

// Path: videoDetail.player
class _TranslationsVideoDetailPlayerZhTw extends TranslationsVideoDetailPlayerEn {
	_TranslationsVideoDetailPlayerZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
class _TranslationsVideoDetailSkeletonZhTw extends TranslationsVideoDetailSkeletonEn {
	_TranslationsVideoDetailSkeletonZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
class _TranslationsVideoDetailCastZhTw extends TranslationsVideoDetailCastEn {
	_TranslationsVideoDetailCastZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
class _TranslationsVideoDetailLikeAvatarsZhTw extends TranslationsVideoDetailLikeAvatarsEn {
	_TranslationsVideoDetailLikeAvatarsZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
// Path: forum.sitewide
class _TranslationsForumSitewideZhTw extends TranslationsForumSitewideEn {
	_TranslationsForumSitewideZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
// Path: forum.errors
class _TranslationsForumErrorsZhTw extends TranslationsForumErrorsEn {
	_TranslationsForumErrorsZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
// Path: forum.groups
class _TranslationsForumGroupsZhTw extends TranslationsForumGroupsEn {
	_TranslationsForumGroupsZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
class _TranslationsForumLeafNamesZhTw extends TranslationsForumLeafNamesEn {
	_TranslationsForumLeafNamesZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
class _TranslationsForumLeafDescriptionsZhTw extends TranslationsForumLeafDescriptionsEn {
	_TranslationsForumLeafDescriptionsZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
class _TranslationsNotificationsErrorsZhTw extends TranslationsNotificationsErrorsEn {
	_TranslationsNotificationsErrorsZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
class _TranslationsConversationErrorsZhTw extends TranslationsConversationErrorsEn {
	_TranslationsConversationErrorsZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
// Path: splash.errors
class _TranslationsSplashErrorsZhTw extends TranslationsSplashErrorsEn {
	_TranslationsSplashErrorsZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
class _TranslationsDownloadErrorsZhTw extends TranslationsDownloadErrorsEn {
	_TranslationsDownloadErrorsZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
class _TranslationsDownloadRestoredPausedZhTw extends TranslationsDownloadRestoredPausedEn {
	_TranslationsDownloadRestoredPausedZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
class _TranslationsDownloadCategoryZhTw extends TranslationsDownloadCategoryEn {
	_TranslationsDownloadCategoryZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
class _TranslationsDownloadBatchDownloadZhTw extends TranslationsDownloadBatchDownloadEn {
	_TranslationsDownloadBatchDownloadZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
class _TranslationsFavoriteErrorsZhTw extends TranslationsFavoriteErrorsEn {
	_TranslationsFavoriteErrorsZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
class _TranslationsTranslationPresetNamesZhTw extends TranslationsTranslationPresetNamesEn {
	_TranslationsTranslationPresetNamesZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
class _TranslationsMediaPlayerNoticeZhTw extends TranslationsMediaPlayerNoticeEn {
	_TranslationsMediaPlayerNoticeZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
class _TranslationsDiagnosticsHealthAlertZhTw extends TranslationsDiagnosticsHealthAlertEn {
	_TranslationsDiagnosticsHealthAlertZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
class _TranslationsDiagnosticsToastZhTw extends TranslationsDiagnosticsToastEn {
	_TranslationsDiagnosticsToastZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
class _TranslationsSearchFilterSortTypesZhTw extends TranslationsSearchFilterSortTypesEn {
	_TranslationsSearchFilterSortTypesZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
class _TranslationsAnime4kPresetGroupsZhTw extends TranslationsAnime4kPresetGroupsEn {
	_TranslationsAnime4kPresetGroupsZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
class _TranslationsAnime4kPresetDescriptionsZhTw extends TranslationsAnime4kPresetDescriptionsEn {
	_TranslationsAnime4kPresetDescriptionsZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
class _TranslationsAnime4kPresetNamesZhTw extends TranslationsAnime4kPresetNamesEn {
	_TranslationsAnime4kPresetNamesZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
class _TranslationsLocalMediaBrowseZhTw extends TranslationsLocalMediaBrowseEn {
	_TranslationsLocalMediaBrowseZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
class _TranslationsLocalMediaItemInfoLabelsZhTw extends TranslationsLocalMediaItemInfoLabelsEn {
	_TranslationsLocalMediaItemInfoLabelsZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
	...
	@override String get neverPlayed => '還沒看過';
	@override String get completed => '已看完';
}

// Path: localMedia.missing
class _TranslationsLocalMediaMissingZhTw extends TranslationsLocalMediaMissingEn {
	_TranslationsLocalMediaMissingZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);

	final TranslationsZhTw _root; // ignore: unused_field

	// Translations
	@override String get title => '找不到這個檔案';
	@override String get rescanFolder => '重新掃描資料夾';
	@override String get relistNas => '重新列出這個資料夾';
	@override String get removeFromList => '從列表移除';
	@override String get removed => '已從列表移除，磁碟上的檔案沒有變動';
	@override String get found => '找到了';
	@override String nasGone({required Object name}) => 'NAS 上已經找不到「${name}」：可能被刪除、移動或改了名。重新列一遍這個資料夾，就能看到它現在的樣子。';
}

// Path: localMedia.webdav
class _TranslationsLocalMediaWebdavZhTw extends TranslationsLocalMediaWebdavEn {
	_TranslationsLocalMediaWebdavZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);

	final TranslationsZhTw _root; // ignore: unused_field

	// Translations
	@override String get addNas => '連接 NAS（WebDAV）';
	@override String get connectTitle => '連接 NAS';
	@override String get editTitle => '重新登入 NAS';
	@override String get hint => '在 NAS 管理頁開啟 WebDAV 服務後，填入它的位址和帳號。';
	@override String get address => '位址';
	@override String get addressHint => '例如 192.168.1.10:5005';
	@override String get username => '使用者名稱';
	@override String get password => '密碼';
	@override String get displayName => '名稱（可選）';
	@override String get connect => '連接';
	@override String get invalidAddress => '位址格式不對';
	@override String get errorAuth => '使用者名稱或密碼不對';
	@override String get errorUnreachable => '連不上伺服器：檢查位址和連接埠，以及裝置和 NAS 是否在同一網路';
	@override String get errorNotWebdav => '這個位址不是 WebDAV 服務';
	@override String errorGeneric({required Object code}) => '連接失敗（${code}）';
	@override String get errorCredUnreadable => '讀取已儲存的密碼失敗，請稍後重試';
	@override String get certTitle => '信任這個伺服器？';
	@override String get certBody => '伺服器的憑證不受系統信任（NAS 自簽憑證常見這種情況）。請確認下面的指紋與 NAS 管理頁顯示的一致：';
	@override String get certChangedBody => '這個伺服器的憑證和上次信任的不一樣。如果你沒有更換過 NAS 的憑證，可能有人在冒充它，請不要繼續。';
	@override String get trust => '信任';
	@override String get pickRootTitle => '選擇要加入的資料夾';
	@override String get serverRoot => '根目錄';
	@override String get alreadyAdded => '這個 NAS 資料夾已經加入過了';
	@override String get relogin => '重新登入';
	@override String get stateAuthFailed => '需要重新登入';
	@override String get stateCertUntrusted => '伺服器憑證已變更';
	@override String get stateUnreachable => '連不上 NAS';
	@override String get stateCredUnreadable => '讀取密碼失敗';
	@override String get connected => '已連接';
	@override String get errorForbidden => '這個帳號沒有 WebDAV 存取權限：請在 NAS 的 WebDAV 設定裡為它開啟權限';
	@override String get errorTls => '安全連線失敗：檢查位址開頭的 http:// 或 https:// 是否與 NAS 設定一致';
	@override String get errorTryHttps => '如果 NAS 只開了 HTTPS，請在位址前加上 https://';
	@override String get previousStep => '上一步';
	@override String get bannerUnreachable => '連不上 NAS，下面是上次看到的內容';
	@override String get bannerAuthFailed => '登入已失效，重新登入後才能看到最新內容';
	@override String get bannerCertUntrusted => 'NAS 的憑證變了，確認之後才能繼續';
...
class _TranslationsVideoDetailGestureGuideQuestZhTw extends TranslationsVideoDetailGestureGuideQuestEn {
	...
	@override String get intro => '看看控制器上的哪個鍵會做什麼，再回到你的空間裡試一試。';
	@override String get videoTab => '空間影片';
	@override String get galleryTab => '空間圖庫';
	@override String get scopeNote => '適用於 Quest 空間中的幕布與視窗。可隨時從播放器設定重新開啟。';
	@override String get catalog => '選擇一個操作';
	@override String lessonCount({required Object current, required Object total}) => '${current} / ${total}';
	@override String get previous => '上一個';
	@override String get next => '下一個操作';
	@override String get replay => '重播示範';
	@override String get pauseDemo => '暫停示範';
	@override String get resumeDemo => '繼續示範';
	@override String get looping => '操作示範';
	@override String get still => '靜態示意';
	@override String get done => '知道了，繼續';
	@override String get leftController => '左手';
	@override String get rightController => '右手';
	@override String get trigger => '食指扳機';
	@override String get grip => '側握鍵';
	@override String get bothGrips => '雙手側握鍵';
	@override String get stick => '搖桿';
	@override String get handTracking => '手勢追蹤';
	@override String get ready => '準備';
	@override String get press => '按下';
	@override String get hold => '保持';
	@override String get release => '放開';
	@override String get result => '查看效果';
	@override String get pinch => '捏合';
	@override String get selectTitle => '用射線點選';
	@override String get selectBody => '將射線對準按鈕，輕扣並放開食指扳機即可選擇。控制面板上的播放、設定和滑桿都可以這樣操作。';
	@override String get selectHint => '食指扳機在圓盤背面；控制器內側的側握鍵用於抓取視窗。';
	@override String get panelTitle => '喚出或收起面板';
	@override String get panelBody => '將射線移到控制面板外，輕扣並放開食指扳機，切換面板的顯示狀態。用手時，在面板外輕捏一下也可以。';
	@override String get panelHint => '短按後放開即可。按住拖動是在操作畫面或視窗，不會切換面板。';
	@override String get playTitle => '播放與暫停';
	@override String get playBody => '射線離開控制面板後，按右手 A 或左手 X，切換影片播放與暫停。也可以直接點控制面板上的播放按鈕。';
	@override String get playHint => '這是預設快捷鍵，可在空間播放器設定中關閉。射線停在面板上時，按鍵優先操作面板。';
	@override String get seekTitle => '用搖桿調整進度';
	@override String get seekBody => '任一搖桿向左或向右輕撥一次，後退或快進 5 秒。持續推住會逐漸加速，預覽目標時間，放開搖桿後才跳轉。';
	@override String get seekHint => '操作這隻搖桿時，讓它的射線離開控制面板；指向面板時搖桿會捲動面板。';
	@override String get browseTitle => '用搖桿翻閱圖庫';
	@override String get browseBody => '任一搖桿向左或向右撥動，查看上一項或下一項，按住可連續翻閱。也可以用射線點選膠片列中的縮圖。';
	@override String get browseHint => '圖庫中的影片也按「項」翻閱。射線指向控制面板時，搖桿用於捲動面板。';
	@override String get swipeTitle => '按住畫面，橫拖翻頁';
	@override String get swipeBody => '對準大圖，按住食指扳機向左拖動，出現翻頁提示後放開，進入下一項；向右拖則返回上一項。捏合拖動也可以。';
	@override String get swipeHint => '圖片在 1× 時才能橫拖翻頁，圖庫裡的影片也支援。拖動時舞台保持原位，放開才換圖。';
	@override String get zoomTitle => '放大圖片細節';
	@override String get zoomBody => '對準圖片中想看的位置，按住食指扳機，再向上推搖桿放大，向下推縮小。縮放以射線按下的位置為中心。';
	@override String get zoomHint => '只放大圖片內容，視窗大小不變。未按住圖片時，搖桿上下調整的是觀看距離。';
	@override String get panTitle => '移動細節與還原';
	@override String get panBody => '圖片放大後，按住食指扳機拖動可查看其他部分。連按兩下圖片可在 2.5× 放大和還原之間切換，手勢追蹤下也可快速捏合兩次。';
	@override String get panHint => '放大狀態下，拖動用於平移；還原到 1× 後，橫拖才會翻頁。';
	@override String get slideshowTitle => '自動播放圖庫';
	@override String get slideshowBody => '看圖片時，按 A / X 開始或暫停幻燈片；在控制面板中選擇 3、5、10 或 20 秒的間隔，也可切換標準畫質或原圖。';
	@override String get slideshowHint => '遇到圖庫中的影片時，A / X 控制這段影片的播放與暫停。快捷鍵需在設定中保持開啟。';
	@override String get moveTitle => '抓起並移動幕布';
	@override String get moveBody => '按住控制器內側的側握鍵，移動控制器，把幕布放到舒服的位置，再放開。觀看時不必瞄準幕布即可抓起它。';
	@override String get moveHint => '瞄準應用視窗或控制面板時，會優先抓取那塊視窗。全景影片用抓握調整朝向。';
	@override String get scaleTitle => '雙手改變幕布大小';
	@override String get scaleBody => '同時按住兩隻控制器的側握鍵，雙手拉開放大，靠攏縮小。手勢追蹤時，也可雙手同時捏住後拉開或靠攏。';
	@override String get scaleHint => '適用於平面或弧形幕布，圖庫舞台也支援。讓射線離開控制面板；這會改變整塊幕布的大小。';
	@override String get distanceTitle => '調整觀看距離';
	@override String get distanceBody => '搖桿向上推遠，向下拉近。抓著某塊視窗時，搖桿上下會調整那塊視窗的距離。音量請在控制面板中調整。';
	@override String get distanceHint => '射線要離開控制面板。圖庫中按住圖片再推搖桿會改為縮放細節；全景影片調整的是觀看視野。';
	@override String get resizeTitle => '拖動窗邊與窗角';
	@override String get resizeBody => '射線靠近窗邊時會亮起邊框。對準邊緣，按住扳機或捏合可移動視窗；對準角落，按住拖動可改變大小。';
	@override String get resizeHint => '應用視窗、控制面板和幕布使用同一套操作。應用視窗可調整寬高，幕布保持畫面比例。';
	@override String get navigationTitle => '返回與空間設定';
	@override String get navigationBody => 'B / Y 每次返回一層：先關閉浮層或返回面板首頁，再收起面板，最後回到應用。左手 Menu 鍵可直接喚出空間設定。';
	@override String get navigationHint => '右手 Meta 鍵由系統處理。使用系統重新置中可把視線前方設為中心，保留幕布大小和距離。';
	@override String get handsTitle => '放下控制器，用手操作';
	@override String get handsBody => '開啟手勢追蹤後，用系統射線瞄準按鈕，食指與拇指捏合並放開即可選擇。播放、進度和圖庫翻頁都可透過控制面板操作。';
	@override String get handsHint => '輕捏面板外可切換面板顯隱；捏住窗邊可移動，捏住窗角可縮放，雙手捏住拉開可放大幕布。';
}

// Path: videoDetail.cast.deviceTypes
class _TranslationsVideoDetailCastDeviceTypesZhTw extends TranslationsVideoDetailCastDeviceTypesEn {
	_TranslationsVideoDetailCastDeviceTypesZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
class _TranslationsVideoDetailCastDlnaCastSheetZhTw extends TranslationsVideoDetailCastDlnaCastSheetEn {
	_TranslationsVideoDetailCastDlnaCastSheetZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
extension on TranslationsZhTw {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'common.privacyHint' => '隱私模式已開啟，內容不予展示',
			'common.latest' => '最新',
			...
			'common.totalComments' => ({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('zh'))(n, one: '評論 ${n} 則', other: '評論 ${n} 則', ), 
			...
			'common.justNow' => '剛剛',
			'common.minutesAgo' => ({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('zh'))(n, one: '${n} 分鐘前', other: '${n} 分鐘前', ), 
			'common.hoursAgo' => ({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('zh'))(n, one: '${n} 小時前', other: '${n} 小時前', ), 
			...
			'common.videoCount' => ({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('zh'))(n, one: '${n} 支影片', other: '${n} 支影片', ), 
			'common.share' => '分享',
			...
			'settings.showFullscreenUpNextHint' => '顯示「接著看」入口',
			'settings.showFullscreenUpNextHintDesc' => '在播放器右緣顯示一枚把手，用來開啟影片池抽屜（來源 / 播放清單 / 稍後再看）。關掉之後就沒有其他入口了。',
			...
			'settings.glassEffectIntroContent' => '現在頂欄、底欄與選單用的是液態玻璃（真實的模糊與折射）。若在裝置上覺得卡頓或偏好簡潔，可以現在換成 Material（不透明、無模糊、無陰影）。',
			'settings.glassEffectIntroHint' => '之後隨時可以在「設定 → 主題設定 → 介面材質」裡修改。',
			...
			'settings.signatureRegenerate' => '換一句',
			...
			'settings.languageNativeName' => '繁體中文',
			'settings.followSystemLanguage' => '跟隨系統',
			'settings.languageChangedMessage' => '語言切換成功，部分功能需重啟應用生效',
			...
			'videoDetail.gestureGuide.sampleVideo' => '範例影片',
			...
			'videoDetail.gestureGuide.quest.intro' => '看看控制器上的哪個鍵會做什麼，再回到你的空間裡試一試。',
			'videoDetail.gestureGuide.quest.videoTab' => '空間影片',
			'videoDetail.gestureGuide.quest.galleryTab' => '空間圖庫',
			'videoDetail.gestureGuide.quest.scopeNote' => '適用於 Quest 空間中的幕布與視窗。可隨時從播放器設定重新開啟。',
			'videoDetail.gestureGuide.quest.catalog' => '選擇一個操作',
			'videoDetail.gestureGuide.quest.lessonCount' => ({required Object current, required Object total}) => '${current} / ${total}',
			'videoDetail.gestureGuide.quest.previous' => '上一個',
			'videoDetail.gestureGuide.quest.next' => '下一個操作',
			'videoDetail.gestureGuide.quest.replay' => '重播示範',
			'videoDetail.gestureGuide.quest.pauseDemo' => '暫停示範',
			'videoDetail.gestureGuide.quest.resumeDemo' => '繼續示範',
			'videoDetail.gestureGuide.quest.looping' => '操作示範',
			'videoDetail.gestureGuide.quest.still' => '靜態示意',
			...
			'videoDetail.gestureGuide.quest.stick' => '搖桿',
			'videoDetail.gestureGuide.quest.handTracking' => '手勢追蹤',
			'videoDetail.gestureGuide.quest.ready' => '準備',
			'videoDetail.gestureGuide.quest.press' => '按下',
			'videoDetail.gestureGuide.quest.hold' => '保持',
			'videoDetail.gestureGuide.quest.release' => '放開',
			'videoDetail.gestureGuide.quest.result' => '查看效果',
			'videoDetail.gestureGuide.quest.pinch' => '捏合',
			'videoDetail.gestureGuide.quest.selectTitle' => '用射線點選',
			'videoDetail.gestureGuide.quest.selectBody' => '將射線對準按鈕，輕扣並放開食指扳機即可選擇。控制面板上的播放、設定和滑桿都可以這樣操作。',
			...
			'videoDetail.gestureGuide.quest.seekBody' => '任一搖桿向左或向右輕撥一次，後退或快進 5 秒。持續推住會逐漸加速，預覽目標時間，放開搖桿後才跳轉。',
			'videoDetail.gestureGuide.quest.seekHint' => '操作這隻搖桿時，讓它的射線離開控制面板；指向面板時搖桿會捲動面板。',
			...
			'videoDetail.gestureGuide.quest.zoomTitle' => '放大圖片細節',
			'videoDetail.gestureGuide.quest.zoomBody' => '對準圖片中想看的位置，按住食指扳機，再向上推搖桿放大，向下推縮小。縮放以射線按下的位置為中心。',
			'videoDetail.gestureGuide.quest.zoomHint' => '只放大圖片內容，視窗大小不變。未按住圖片時，搖桿上下調整的是觀看距離。',
			'videoDetail.gestureGuide.quest.panTitle' => '移動細節與還原',
			'videoDetail.gestureGuide.quest.panBody' => '圖片放大後，按住食指扳機拖動可查看其他部分。連按兩下圖片可在 2.5× 放大和還原之間切換，手勢追蹤下也可快速捏合兩次。',
			'videoDetail.gestureGuide.quest.panHint' => '放大狀態下，拖動用於平移；還原到 1× 後，橫拖才會翻頁。',
			'videoDetail.gestureGuide.quest.slideshowTitle' => '自動播放圖庫',
			'videoDetail.gestureGuide.quest.slideshowBody' => '看圖片時，按 A / X 開始或暫停幻燈片；在控制面板中選擇 3、5、10 或 20 秒的間隔，也可切換標準畫質或原圖。',
			'videoDetail.gestureGuide.quest.slideshowHint' => '遇到圖庫中的影片時，A / X 控制這段影片的播放與暫停。快捷鍵需在設定中保持開啟。',
			'videoDetail.gestureGuide.quest.moveTitle' => '抓起並移動幕布',
			'videoDetail.gestureGuide.quest.moveBody' => '按住控制器內側的側握鍵，移動控制器，把幕布放到舒服的位置，再放開。觀看時不必瞄準幕布即可抓起它。',
			'videoDetail.gestureGuide.quest.moveHint' => '瞄準應用視窗或控制面板時，會優先抓取那塊視窗。全景影片用抓握調整朝向。',
			'videoDetail.gestureGuide.quest.scaleTitle' => '雙手改變幕布大小',
			'videoDetail.gestureGuide.quest.scaleBody' => '同時按住兩隻控制器的側握鍵，雙手拉開放大，靠攏縮小。手勢追蹤時，也可雙手同時捏住後拉開或靠攏。',
			'videoDetail.gestureGuide.quest.scaleHint' => '適用於平面或弧形幕布，圖庫舞台也支援。讓射線離開控制面板；這會改變整塊幕布的大小。',
			'videoDetail.gestureGuide.quest.distanceTitle' => '調整觀看距離',
			'videoDetail.gestureGuide.quest.distanceBody' => '搖桿向上推遠，向下拉近。抓著某塊視窗時，搖桿上下會調整那塊視窗的距離。音量請在控制面板中調整。',
			'videoDetail.gestureGuide.quest.distanceHint' => '射線要離開控制面板。圖庫中按住圖片再推搖桿會改為縮放細節；全景影片調整的是觀看視野。',
			'videoDetail.gestureGuide.quest.resizeTitle' => '拖動窗邊與窗角',
			'videoDetail.gestureGuide.quest.resizeBody' => '射線靠近窗邊時會亮起邊框。對準邊緣，按住扳機或捏合可移動視窗；對準角落，按住拖動可改變大小。',
			'videoDetail.gestureGuide.quest.resizeHint' => '應用視窗、控制面板和幕布使用同一套操作。應用視窗可調整寬高，幕布保持畫面比例。',
			'videoDetail.gestureGuide.quest.navigationTitle' => '返回與空間設定',
			'videoDetail.gestureGuide.quest.navigationBody' => 'B / Y 每次返回一層：先關閉浮層或返回面板首頁，再收起面板，最後回到應用。左手 Menu 鍵可直接喚出空間設定。',
			'videoDetail.gestureGuide.quest.navigationHint' => '右手 Meta 鍵由系統處理。使用系統重新置中可把視線前方設為中心，保留幕布大小和距離。',
			'videoDetail.gestureGuide.quest.handsTitle' => '放下控制器，用手操作',
			'videoDetail.gestureGuide.quest.handsBody' => '開啟手勢追蹤後，用系統射線瞄準按鈕，食指與拇指捏合並放開即可選擇。播放、進度和圖庫翻頁都可透過控制面板操作。',
			'videoDetail.gestureGuide.quest.handsHint' => '輕捏面板外可切換面板顯隱；捏住窗邊可移動，捏住窗角可縮放，雙手捏住拉開可放大幕布。',
			'videoDetail.home' => '首頁',
			...
			'forum.floorNotFound' => '該樓層不存在或已被刪除',
			'forum.floorNotLoadedYet' => '該樓層在更早的位置，繼續向上載入後才能跳轉',
			'forum.editedAt' => '編輯時間',
			...
			'mediaPlayer.unableToPlayNasVideo' => ({required Object error}) => '無法播放 NAS 上的影片：${error}',
			...
			'anime4k.compatibilityTip' => '⚠️ 部分行動裝置 GPU（如麒麟 980 / Mali-G76）無法渲染任何自訂著色器。若開啟後出現「有聲音但畫面全黑」，請在此關閉 Anime4K。',
			'anime4k.autoDisabledOnRenderFailure' => '目前裝置 GPU 無法渲染 Anime4K 著色器，已自動關閉。',
			'siteMode.title' => '站點模式',
			...
			'externalPlayer.title' => '用其他應用程式開啟',
			'externalPlayer.description' => '把目前影片交給本機的其它播放器，例如 VR 頭顯上的 Skybox、Pigasus，手機上的 MX Player、VLC',
			'externalPlayer.openWithOtherApp' => '選擇其他應用程式開啟',
			'externalPlayer.openWithOtherAppDescription' => '彈出系統選擇器，挑一個播放器接手',
			'externalPlayer.openWithSystemPlayer' => '用系統預設播放器開啟',
			'externalPlayer.openWithSystemPlayerDescription' => '交給系統關聯的預設影片程式',
			'externalPlayer.copyLink' => '複製影片連結',
			'externalPlayer.copyLinkDescription' => '給只能貼上連結的播放器用，例如 Skybox、DeoVR',
			'externalPlayer.linkCopied' => '影片連結已複製',
			...
			'externalPlayer.localFileMissing' => '本機檔案不存在，可能已被刪除',
			...
			'externalPlayer.detecting' => '偵測中…',
			'externalPlayer.detectFound' => ({required Object count}) => '偵測到 ${count} 個播放器',
			'externalPlayer.detectNothingFound' => '沒有偵測到新的播放器，可以手動新增',
			'externalPlayer.autoDetectedTag' => '自動偵測',
			'externalPlayer.addPlayer' => '新增播放器',
			'externalPlayer.editPlayer' => '編輯播放器',
			'externalPlayer.playerName' => '名稱',
			'externalPlayer.executablePath' => '可執行檔',
			'externalPlayer.browse' => '瀏覽',
			'externalPlayer.argumentTemplate' => '啟動參數',
			'externalPlayer.argumentTemplateHint' => '用 {input} 代表影片路徑或連結；留空就是把它當唯一參數傳給播放器',
			'externalPlayer.nameAndPathRequired' => '名稱和可執行檔都不能為空',
			'externalPlayer.testLaunch' => '測試啟動',
			'externalPlayer.testLaunched' => '播放器已啟動',
			...
			'vrFormat.panelSettingsDesc' => '這塊應用面板放多遠，背後透出多少真實房間',
			'vrFormat.panelDistance' => '面板距離',
			'vrFormat.panelDistanceValue' => ({required Object meters}) => '${meters} 公尺',
			'vrFormat.panelResetPlacement' => '重設位置',
			'vrFormat.panelResetBackground' => '恢復預設',
			'vrFormat.panelBackground' => '背景不透明度',
			'vrFormat.panelBackgroundHint' => '0%：純黑環境，只剩畫面 · 100%：環境光下的真實房間',
			'vrFormat.panelUnavailable' => '面板此刻不在場，稍後再試',
			...
			'localMedia.scanQueued' => '排隊等待掃描',
			'localMedia.itemInfo' => '檔案資訊',
			'localMedia.revealInFolder' => '在資料夾中顯示',
			'localMedia.rescanAll' => '全部重新掃描',
			...
			'localMedia.itemInfoLabels.resolution' => '解析度',
			'localMedia.itemInfoLabels.duration' => '時長',
			'localMedia.itemInfoLabels.modified' => '修改時間',
			'localMedia.itemInfoLabels.lastPlayed' => '上次播放',
			'localMedia.itemInfoLabels.neverPlayed' => '還沒看過',
			'localMedia.itemInfoLabels.completed' => '已看完',
			'localMedia.addSource' => '新增來源',
			'localMedia.addSourceKinds' => '資料夾 · NAS',
			'localMedia.openSettings' => '去設定開啟',
			'localMedia.removeSourceLoses' => ({required Object items}) => '以下內容會一起清除，重新新增也找不回來：${items}',
			'localMedia.loseProgress' => ({required Object count}) => '${count} 筆觀看進度',
			'localMedia.loseFavorites' => ({required Object count}) => '${count} 個精選',
			'localMedia.losePinned' => ({required Object count}) => '${count} 個常用目錄',
			'localMedia.loseHidden' => ({required Object count}) => '${count} 個隱藏設定',
			'localMedia.loseCovers' => ({required Object count}) => '${count} 張手選封面',
			'localMedia.renameSource' => '重新命名',
			'localMedia.renameSourceTitle' => '重新命名來源',
			'localMedia.renameSourceLabel' => '名稱',
			'localMedia.renamed' => '已重新命名',
			'localMedia.nasAggregateHint' => 'NAS 上的內容只收錄開啟過的資料夾。沒開啟過的資料夾，裡面的影片和圖片不會出現在這裡。',
			'localMedia.rescanDone' => ({required Object name}) => '「${name}」已更新',
			'localMedia.unknownSourceHint' => '這個來源需要更新版本的應用才能使用',
			'localMedia.missing.title' => '找不到這個檔案',
			'localMedia.missing.rescanFolder' => '重新掃描資料夾',
			'localMedia.missing.relistNas' => '重新列出這個資料夾',
			'localMedia.missing.removeFromList' => '從列表移除',
			'localMedia.missing.removed' => '已從列表移除，磁碟上的檔案沒有變動',
			'localMedia.missing.found' => '找到了',
			'localMedia.missing.nasGone' => ({required Object name}) => 'NAS 上已經找不到「${name}」：可能被刪除、移動或改了名。重新列一遍這個資料夾，就能看到它現在的樣子。',
			'localMedia.webdav.addNas' => '連接 NAS（WebDAV）',
			'localMedia.webdav.connectTitle' => '連接 NAS',
			'localMedia.webdav.editTitle' => '重新登入 NAS',
			'localMedia.webdav.hint' => '在 NAS 管理頁開啟 WebDAV 服務後，填入它的位址和帳號。',
			'localMedia.webdav.address' => '位址',
			'localMedia.webdav.addressHint' => '例如 192.168.1.10:5005',
			'localMedia.webdav.username' => '使用者名稱',
			'localMedia.webdav.password' => '密碼',
			'localMedia.webdav.displayName' => '名稱（可選）',
			'localMedia.webdav.connect' => '連接',
			'localMedia.webdav.invalidAddress' => '位址格式不對',
			'localMedia.webdav.errorAuth' => '使用者名稱或密碼不對',
			'localMedia.webdav.errorUnreachable' => '連不上伺服器：檢查位址和連接埠，以及裝置和 NAS 是否在同一網路',
			'localMedia.webdav.errorNotWebdav' => '這個位址不是 WebDAV 服務',
			'localMedia.webdav.errorGeneric' => ({required Object code}) => '連接失敗（${code}）',
			'localMedia.webdav.errorCredUnreadable' => '讀取已儲存的密碼失敗，請稍後重試',
			'localMedia.webdav.certTitle' => '信任這個伺服器？',
			'localMedia.webdav.certBody' => '伺服器的憑證不受系統信任（NAS 自簽憑證常見這種情況）。請確認下面的指紋與 NAS 管理頁顯示的一致：',
			'localMedia.webdav.certChangedBody' => '這個伺服器的憑證和上次信任的不一樣。如果你沒有更換過 NAS 的憑證，可能有人在冒充它，請不要繼續。',
			'localMedia.webdav.trust' => '信任',
			'localMedia.webdav.pickRootTitle' => '選擇要加入的資料夾',
			'localMedia.webdav.serverRoot' => '根目錄',
			'localMedia.webdav.alreadyAdded' => '這個 NAS 資料夾已經加入過了',
			'localMedia.webdav.relogin' => '重新登入',
			'localMedia.webdav.stateAuthFailed' => '需要重新登入',
			'localMedia.webdav.stateCertUntrusted' => '伺服器憑證已變更',
			'localMedia.webdav.stateUnreachable' => '連不上 NAS',
			'localMedia.webdav.stateCredUnreadable' => '讀取密碼失敗',
			'localMedia.webdav.connected' => '已連接',
			'localMedia.webdav.errorForbidden' => '這個帳號沒有 WebDAV 存取權限：請在 NAS 的 WebDAV 設定裡為它開啟權限',
			'localMedia.webdav.errorTls' => '安全連線失敗：檢查位址開頭的 http:// 或 https:// 是否與 NAS 設定一致',
			'localMedia.webdav.errorTryHttps' => '如果 NAS 只開了 HTTPS，請在位址前加上 https://',
			'localMedia.webdav.previousStep' => '上一步',
			'localMedia.webdav.bannerUnreachable' => '連不上 NAS，下面是上次看到的內容',
			'localMedia.webdav.bannerAuthFailed' => '登入已失效，重新登入後才能看到最新內容',
			'localMedia.webdav.bannerCertUntrusted' => 'NAS 的憑證變了，確認之後才能繼續',
			'localMedia.webdav.bannerCredUnreadable' => '讀取儲存的密碼失敗，重新登入一次即可',
			...
			'localMedia.permissionDenied' => '未授予檔案存取權限，新增資料夾前需要先開啟',
			'localMedia.noVideosFound' => '這個資料夾裡沒有影片',
			'localMedia.emptyTitle' => '新增資料夾或連接 NAS，看你已有的影片',
			'localMedia.emptyPrivacyNote' => '只在本機讀取，不上傳任何東西。',
			'localMedia.removeSourceTitle' => ({required Object name}) => '移除「${name}」？',
			'localMedia.removeSourceBody' => '檔案本身一個不動，只是把它從本機媒體庫移出去。',
			'localMedia.remove' => '移除',
			'localMedia.removeFolder' => '移除來源',
			'localMedia.removeFolderSelectTitle' => '選擇要移除的來源',
			...
			'ai.title' => 'AI',
			'ai.providers' => '供應商',
			'ai.providersHint' => '新增一個或多個 AI 供應商，再為每項功能指定用哪一個。',
			'ai.addProvider' => '新增供應商',
			'ai.noProviders' => '還沒有供應商。新增一個之後，翻譯、搜尋和小尾巴才能用上 AI。',
			'ai.pickPreset' => '選擇供應商',
			'ai.providerNameLabel' => '名稱',
			'ai.apiKey' => 'API 金鑰',
			'ai.baseUrl' => '端點位址',
			'ai.model' => '模型',
			'ai.modelPick' => '選擇模型',
			...
			'ai.structuredOutputHint' => 'AI 搜尋要用它。不少中轉端點並不支援，搜尋老是失敗就關掉。',
			'ai.temperature' => '溫度',
			'ai.maxTokens' => '最大 token',
			'ai.maxTokensAuto' => '自動（模型上限）',
			'ai.test' => '測試',
			'ai.testOk' => '連線正常',
			'ai.deleteProvider' => '刪除供應商',
			'ai.usedBy' => '正在用於',
			'ai.taskBindings' => '功能分配',
			'ai.taskBindingsHint' => '每項功能可以指定不同的供應商。',
			'ai.taskTranslate' => '翻譯',
			'ai.taskSearch' => 'AI 搜尋',
			...
			'ai.searchEmpty' => '沒能從這句話裡解析出搜尋條件，換個說法試試',
			'ai.searchFilters' => '篩選條件',
			'ai.searchSwitchSegment' => ({required Object segment}) => '切換到「${segment}」',
			'ai.searchGenerating' => '正在理解…',
			'ai.searchRetrying' => '上一次失敗了，正在重試…',
			'ai.searchRetryReason' => ({required Object reason}) => '失敗原因：${reason}',
			'ai.searchStageWaiting' => '已送出請求，等待回應…',
			'ai.searchStageThinkingNext' => '正在繼續思考…',
			'ai.searchStageReasoning' => '正在推理…',
			'ai.searchStageTool' => '正在試搜…',
			'ai.searchStageDrafting' => ({required Object chars}) => '正在寫答案 · 已 ${chars} 字',
			'ai.searchStageParsing' => '正在整理結果…',
