...
class _TranslationsSettingsZhTw implements TranslationsSettingsEn {
	...
	@override String get glassEffectDesc => '決定全域玻璃控件（頂欄膠囊、選單、彈窗按鈕）使用哪種材質；浮動底欄始終是液態玻璃';
	...
	@override String get glassEffectIntroContent => '這一版的頂欄、底欄與選單換成了液態玻璃（真實的模糊與折射）。若在裝置上覺得卡頓或偏好簡潔，可以現在換成輕量半透明（底欄會保持液態）。';
...
extension on TranslationsZhTw {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'settings.glassEffectDesc' => '決定全域玻璃控件（頂欄膠囊、選單、彈窗按鈕）使用哪種材質；浮動底欄始終是液態玻璃',
			...
			'settings.glassEffectIntroContent' => '這一版的頂欄、底欄與選單換成了液態玻璃（真實的模糊與折射）。若在裝置上覺得卡頓或偏好簡潔，可以現在換成輕量半透明（底欄會保持液態）。',
