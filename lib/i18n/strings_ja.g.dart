...
class _TranslationsSettingsJa implements TranslationsSettingsEn {
	...
	@override String get glassEffectDesc => 'ガラス要素（ヘッダーのカプセル、メニュー、ダイアログのボタン）に使う素材を決めます。フローティングタブバーは常に液体ガラスです';
	...
	@override String get glassEffectIntroContent => 'このバージョンからヘッダー・タブバー・メニューがリキッドガラス（本物のぼかしと屈折）になりました。端末で重いと感じる場合やシンプルな見た目が好みなら、今すぐ軽量な半透明に切り替えられます（タブバーはリキッドのままです）。';
...
extension on TranslationsJa {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'settings.glassEffectDesc' => 'ガラス要素（ヘッダーのカプセル、メニュー、ダイアログのボタン）に使う素材を決めます。フローティングタブバーは常に液体ガラスです',
			...
			'settings.glassEffectIntroContent' => 'このバージョンからヘッダー・タブバー・メニューがリキッドガラス（本物のぼかしと屈折）になりました。端末で重いと感じる場合やシンプルな見た目が好みなら、今すぐ軽量な半透明に切り替えられます（タブバーはリキッドのままです）。',
